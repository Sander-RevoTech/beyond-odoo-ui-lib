import { BehaviorSubject, filter, tap, map, Subject, switchMap, take, of, share } from 'rxjs';
...
class BydServerSevice {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.1", ngImport: i0, type: BydServerSevice, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "19.2.1", ngImport: i0, type: BydServerSevice, providedIn: 'root' });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.1", ngImport: i0, type: BydServerSevice, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root',
                }]
...
class BydGraphService {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.1", ngImport: i0, type: BydGraphService, deps: [{ token: i1.HttpLink }, { token: i2.Apollo }], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "19.2.1", ngImport: i0, type: BydGraphService, providedIn: 'root' });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.1", ngImport: i0, type: BydGraphService, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root',
                }]
...
class BydBaseService {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.1", ngImport: i0, type: BydBaseService, deps: "invalid", target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "19.2.1", ngImport: i0, type: BydBaseService, providedIn: 'root' });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.1", ngImport: i0, type: BydBaseService, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root',
                }]
...
class CacheInterceptor {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.1", ngImport: i0, type: CacheInterceptor, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "19.2.1", ngImport: i0, type: CacheInterceptor });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.1", ngImport: i0, type: CacheInterceptor, decorators: [{
            type: Injectable
        }] });
...
class BydPermissionsServices {
    ...
    constructor() {
        if (SessionStorage.has('token')) {
            const token = SessionStorage.get('token').split(this._sep);
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.1", ngImport: i0, type: BydPermissionsServices, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "19.2.1", ngImport: i0, type: BydPermissionsServices, providedIn: 'root' });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.1", ngImport: i0, type: BydPermissionsServices, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root',
                }]
...
const STRAPI_SERVER_CONFIG = new InjectionToken('config_strapi_server');
class BydStrapiService extends BydBaseService {
    _permissionsServices = inject(BydPermissionsServices);
    _config = inject(STRAPI_SERVER_CONFIG);
    constructor() {
        super();
    ...
    authentification$(data) {
        return this._serverService.request(new Request({ type: 'Login', cacheTime: -1, content: data, loginRequired: false })).pipe(tap(data => {
            this._permissionsServices.token = data.jwt;
            this._permissionsServices.setAuthenticated(true);
        }));
    }
    fetchQuery$(payload, node) {
        return this._graphService.fetchQuery(payload, node, 'strapi').pipe(filter(isNonNullable));
    }
    fetchQueryList$(payload, node) {
        return this._graphService.fetchQuery(payload, node, 'strapi').pipe(filter(isNonNullable));
    }
    mutate$(payload, node) {
        return this._graphService.mutate(payload, node, 'strapi').pipe(filter(isNonNullable));
    }
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.1", ngImport: i0, type: BydStrapiService, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "19.2.1", ngImport: i0, type: BydStrapiService, providedIn: 'root' });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.1", ngImport: i0, type: BydStrapiService, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root',
                }]
...
const baseStrapiProps = ['documentId', 'createdAt', 'updatedAt', 'publishedAt'];
...
class BydAuthService extends BydStrapiService {
    constructor() {
        super();
        super.registerRoutes({
            apiRoutes
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.1", ngImport: i0, type: BydAuthService, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "19.2.1", ngImport: i0, type: BydAuthService, providedIn: 'root' });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.1", ngImport: i0, type: BydAuthService, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root',
                }]
...
class BearerInterceptor {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.1", ngImport: i0, type: BearerInterceptor, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "19.2.1", ngImport: i0, type: BearerInterceptor });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.1", ngImport: i0, type: BearerInterceptor, decorators: [{
            type: Injectable
        }], ctorParameters: () => [] });
...
export { BydAuthService, BydBaseService, BydGraphService, BydPermissionsServices, BydServerSevice, BydStrapiService, CacheInterceptor, GRAPHQL_CONFIG_TOKEN, GRAPHQL_SERVER_CONFIG, GraphSchema, HandleComplexRequest, HandleSimpleRequest, Logger, Request, RequestMap, SERVER_CONFIG_KEY, STRAPI_SERVER_CONFIG, StatusReponse, baseStrapiProps, graphQlBydke, graphQlPaginationFields, graphQlUpdateFields, keyValueProps, provideServer };
