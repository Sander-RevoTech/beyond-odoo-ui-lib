...
import { BydButtonComponent, BydTitleComponent, ToastComponent } from '@beyond/ui';
...
class NotificationInlineComponent extends BydBaseComponent {
  ...
  static ɵcmp = i0.ɵɵngDeclareComponent({
    ...
    inputs: { message: 'message', code: 'code', showClose: 'showClose' },
    outputs: { askClose: 'askClose' },
    usesInheritance: true,
    ngImport: i0,
    template:
...
class NotificationBoxComponent extends BydBaseComponent {
  ...
  static ɵcmp = i0.ɵɵngDeclareComponent({
    ...
    styles: [
      '.notification-box_container{position:fixed;bottom:24px;min-width:200px;max-width:500px;right:5%;z-index:5000}\n',
    ],
    dependencies: [
      {
        kind: 'component',
      ...
      { kind: 'component', type: ToastComponent, selector: 'byd-toast', inputs: ['code'] },
    ],
  });
}
i0.ɵɵngDeclareClassMetadata({
