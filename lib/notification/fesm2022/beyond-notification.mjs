...
import { Injectable, inject, Inject, Component, EventEmitter, Output, Input, signal } from '@angular/core';
import { MatIcon } from '@angular/material/icon';
import { tap } from 'rxjs/operators';
import { BydTitleComponent, BydButtonComponent, ToastComponent, BydLinkComponent, LogoComponent } from '@beyond/ui';
...
class NotificationBoxComponent extends BydBaseComponent {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "19.2.1", type: NotificationBoxComponent, isStandalone: true, selector: "byd-notification-box", usesInheritance: true, ngImport: i0, template: "<div>\r\n  <div class=\"notification-box_container flex-column g-space-sm\">\r\n    <div *ngFor=\"let item of this.list\">\r\n      <byd-toast [code]=\"this.getCode(item.code)\">\r\n        <byd-notification-inline\r\n          [message]=\"item.message\"\r\n          [code]=\"item.code\"\r\n          [showClose]=\"false\"\r\n        ></byd-notification-inline>\r\n      </byd-toast>\r\n    </div>\r\n  </div>\r\n  @let userNotif = this.userNotif();\r\n  @if (userNotif) {\r\n    <byd-toast [code]=\"this.getCode(userNotif.code)\" [sticky]=\"true\">\r\n      <div class=\"space-between\">\r\n        {{ userNotif.message }}\r\n        <mat-icon (click)=\"this.userNotif.set(null)\">close</mat-icon>\r\n      </div>\r\n    </byd-toast>\r\n  }\r\n</div>\r\n", styles: [".notification-box_container{position:fixed;bottom:24px;min-width:200px;max-width:500px;right:5%;z-index:5000}\n"], dependencies: [{ kind: "component", type: NotificationInlineComponent, selector: "byd-notification-inline", inputs: ["message", "code", "showClose"], outputs: ["askClose"] }, { kind: "directive", type: NgFor, selector: "[ngFor][ngForOf]", inputs: ["ngForOf", "ngForTrackBy", "ngForTemplate"] }, { kind: "component", type: ToastComponent, selector: "byd-toast", inputs: ["code", "sticky"] }, { kind: "component", type: MatIcon, selector: "mat-icon", inputs: ["color", "inline", "svgIcon", "fontSet", "fontIcon"], exportAs: ["matIcon"] }] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.1", ngImport: i0, type: NotificationBoxComponent, decorators: [{
            type: Component,
            args: [{ selector: 'byd-notification-box', standalone: true, imports: [NotificationInlineComponent, NgFor, ToastComponent, MatIcon], template: "<div>\r\n  <div class=\"notification-box_container flex-column g-space-sm\">\r\n    <div *ngFor=\"let item of this.list\">\r\n      <byd-toast [code]=\"this.getCode(item.code)\">\r\n        <byd-notification-inline\r\n          [message]=\"item.message\"\r\n          [code]=\"item.code\"\r\n          [showClose]=\"false\"\r\n        ></byd-notification-inline>\r\n      </byd-toast>\r\n    </div>\r\n  </div>\r\n  @let userNotif = this.userNotif();\r\n  @if (userNotif) {\r\n    <byd-toast [code]=\"this.getCode(userNotif.code)\" [sticky]=\"true\">\r\n      <div class=\"space-between\">\r\n        {{ userNotif.message }}\r\n        <mat-icon (click)=\"this.userNotif.set(null)\">close</mat-icon>\r\n      </div>\r\n    </byd-toast>\r\n  }\r\n</div>\r\n", styles: [".notification-box_container{position:fixed;bottom:24px;min-width:200px;max-width:500px;right:5%;z-index:5000}\n"] }]
...
export { BydNotificationService, ENotificationCode, NotificationBoxComponent, NotificationInlineComponent, PwaComponent };
