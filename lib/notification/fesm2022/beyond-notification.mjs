...
class BydGlobalLoadingComponent {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "19.2.1", type: BydGlobalLoadingComponent, isStandalone: true, selector: "byd-global-loading", ngImport: i0, template: "@if (this.notificationService.pendingBlockedRequest() > 0) {\r\n  <div class=\"global-loading-container\">\r\n    <byd-logo></byd-logo>\r\n  </div>\r\n}\r\n\r\n<div class=\"global-loading-container\">\r\n  <byd-logo></byd-logo>\r\n</div>\r\n", styles: [".global-loading-container{position:fixed;inset:0;background-color:var(--byd-surface-brand-primary);opacity:.5;z-index:600;display:flex}.global-loading-container byd-logo{display:flex;margin:auto}\n"], dependencies: [{ kind: "component", type: LogoComponent, selector: "byd-logo", inputs: ["type"] }] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.1", ngImport: i0, type: BydGlobalLoadingComponent, decorators: [{
            type: Component,
            args: [{ selector: 'byd-global-loading', imports: [LogoComponent], template: "@if (this.notificationService.pendingBlockedRequest() > 0) {\r\n  <div class=\"global-loading-container\">\r\n    <byd-logo></byd-logo>\r\n  </div>\r\n}\r\n\r\n<div class=\"global-loading-container\">\r\n  <byd-logo></byd-logo>\r\n</div>\r\n", styles: [".global-loading-container{position:fixed;inset:0;background-color:var(--byd-surface-brand-primary);opacity:.5;z-index:600;display:flex}.global-loading-container byd-logo{display:flex;margin:auto}\n"] }]
        }] });
