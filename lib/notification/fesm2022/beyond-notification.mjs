...
import { BydTitleComponent, BydButtonComponent, ToastComponent, BydLinkComponent } from '@beyond/ui';
...
class BydPwaService {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.1", ngImport: i0, type: BydPwaService, deps: [{ token: PWA_CONFIG_KEY }], target: i0.ɵɵFactoryTarget.Injectable });
