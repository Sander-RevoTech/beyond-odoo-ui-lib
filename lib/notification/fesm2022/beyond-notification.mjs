...
class BydNotificationService {
    ...
    clearUserNotification$ = new Subject();
    constructor() { }
    ...
    addNotification(message, code, options) {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydNotificationService, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydNotificationService, providedIn: 'root' });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydNotificationService, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root',
                }]
...
class NotificationBoxComponent extends BydBaseComponent {
    ...
    constructor(_dialog) {
        ...
        this._registerSubscription(this._notificationService.userNotification$
            ...
            .subscribe());
        this._registerSubscription(this._notificationService.clearUserNotification$
            .pipe(tap(() => {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: NotificationBoxComponent, deps: [{ token: i1.MatDialog }], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "19.2.15", type: NotificationBoxComponent, isStandalone: true, selector: "byd-notification-box", usesInheritance: true, ngImport: i0, template: "<div class=\"notification-box_container flex-column g-space-sm\">\r\n  <div *ngFor=\"let item of this.list\">\r\n    <byd-toast [code]=\"this.getCode(item.code)\" [onTop]=\"item.options?.focused ?? false\">\r\n      <byd-notification-inline\r\n        [message]=\"item.message\"\r\n        [code]=\"item.code\"\r\n        [showClose]=\"false\"\r\n      ></byd-notification-inline>\r\n    </byd-toast>\r\n  </div>\r\n  @let userNotif = this.userNotif();\r\n  @if (userNotif) {\r\n    <byd-toast [code]=\"this.getCode(userNotif.code)\" [onTop]=\"true\">\r\n      <div class=\"space-between\">\r\n        {{ userNotif.message }}\r\n        <mat-icon (click)=\"this.userNotif.set(null)\">close</mat-icon>\r\n      </div>\r\n    </byd-toast>\r\n  }\r\n</div>\r\n", styles: [".notification-box_container{position:fixed;bottom:24px;min-width:200px;max-width:500px;right:5%;z-index:5000}\n"], dependencies: [{ kind: "component", type: NotificationInlineComponent, selector: "byd-notification-inline", inputs: ["message", "code", "showClose"], outputs: ["askClose"] }, { kind: "directive", type: NgFor, selector: "[ngFor][ngForOf]", inputs: ["ngForOf", "ngForTrackBy", "ngForTemplate"] }, { kind: "component", type: ToastComponent, selector: "byd-toast", inputs: ["code", "onTop", "inMiddle"] }, { kind: "component", type: MatIcon, selector: "mat-icon", inputs: ["color", "inline", "svgIcon", "fontSet", "fontIcon"], exportAs: ["matIcon"] }] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: NotificationBoxComponent, decorators: [{
            type: Component,
...
class BydPwaService {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydPwaService, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydPwaService, providedIn: 'root' });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydPwaService, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root',
                }]
...
class BydGlobalLoadingComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydGlobalLoadingComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "19.2.15", type: BydGlobalLoadingComponent, isStandalone: true, selector: "byd-global-loading", ngImport: i0, template: "@if (this.notificationService.pendingBlockedRequest() > 0) {\r\n  <div class=\"global-loading-container\">\r\n    <div class=\"m-a d-flex flex-column\">\r\n      <byd-logo></byd-logo>\r\n      <byd-loader [isLoading]=\"true\"></byd-loader>\r\n    </div>\r\n  </div>\r\n}\r\n", styles: [".global-loading-container{position:fixed;inset:0;background-color:var(--byd-surface-brand-primary);opacity:.5;z-index:6000;display:flex}.global-loading-container byd-logo{display:flex;margin:auto;width:25vw}\n"], dependencies: [{ kind: "component", type: LogoComponent, selector: "byd-logo", inputs: ["type"] }, { kind: "component", type: LoaderComponent, selector: "byd-loader", inputs: ["isLoading", "skeleton"] }] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydGlobalLoadingComponent, decorators: [{
            type: Component,
