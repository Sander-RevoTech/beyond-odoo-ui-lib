...
class StopPropagationDirective {
  ...
  static ɵdir = i0.ɵɵngDeclareDirective({
    ...
    inputs: { stopPropagationActivation: 'stopPropagationActivation' },
    host: { listeners: { click: 'onClick($event)' } },
    ngImport: i0,
  });
}
...
class TypedTemplateDirective {
  ...
  static ɵdir = i0.ɵɵngDeclareDirective({
    ...
    inputs: { typedTemplate: 'typedTemplate' },
    ngImport: i0,
  });
}
i0.ɵɵngDeclareClassMetadata({
...
class LetDirective {
  ...
  static ɵfac = i0.ɵɵngDeclareFactory({
    ...
    ngImport: i0,
    type: LetDirective,
    deps: [{ token: i0.ViewContainerRef }, { token: i0.TemplateRef }],
    target: i0.ɵɵFactoryTarget.Directive,
  });
  static ɵdir = i0.ɵɵngDeclareDirective({
    minVersion: '14.0.0',
...
class BreakpointDetection {
  ...
  isMoreThanLG = !this._isMatched([Breakpoints.XSmall, Breakpoints.Small, Breakpoints.Medium, Breakpoints.Large]);
  isLessThanXS$ = this._isMatched$([Breakpoints.XSmall]);
  isLessThanSM$ = this._isMatched$([Breakpoints.XSmall, Breakpoints.Small]);
  isLessThanMD$ = this._isMatched$([Breakpoints.XSmall, Breakpoints.Small, Breakpoints.Medium]);
  isLessThanLG$ = this._isMatched$([Breakpoints.XSmall, Breakpoints.Small, Breakpoints.Medium, Breakpoints.Large]);
  ...
  isMoreThanMD$ = this._isMatched$([Breakpoints.XSmall, Breakpoints.Small, Breakpoints.Medium]).pipe(
    map(value => !value)
  );
  isMoreThanLG$ = this._isMatched$([Breakpoints.XSmall, Breakpoints.Small, Breakpoints.Medium, Breakpoints.Large]).pipe(
    map(value => !value)
  );
...
class BydBasePage extends BydAbstractComponent {
  ...
  _filterParams(routeParams, paramsAsked) {
    return routeParams.pipe(
      ...
      map(params => this._getParamsTyped(paramsAsked, params)),
