...
export { APPLICATION_CONFIG, BydAbstractComponent, BydBaseComponent, BydBaseModal, BydBasePage, Civility, EFileExtension, FileSizePipe, HandleEntity, HorizontalScroll, JoinPipe, LetDirective, ObjectKeys, ObjectKeysReOrder, OnRenderDirective, PluralTranslatePipe, RequestState, SafePipe, StopPropagationDirective, SubscriberHandler, TemporaryFile, TimeAgoDirective, TypedTemplateDirective, call, capitalizeFirstLetter, compare, compareHour, compressFile, compressImage, convertToNumber, copyTextToClipboard, createRange, diffInHourAndMinutes, downloadFile, extractEnum, getBase64FromFile, getBase64Image, getBlobImage, getFileExtension, getFirstNumber, getFirstString, getFullFileNameFromUrl, getPropertyTypes, getUniqueArray, getUniqueValues, isLight, isNonNullable, isURL, isValidEmail, keepUniqueObjectByProperty, merge, newGuid, newId, openMap, pathToFile, percentage, picImages, removeElement, removeElementsWithSameProperty, roundToDecimal, s4, sendMail, sort, takeImage, toArray, toLocalDate, toLocalDateString, toUtcDate, trigram };
