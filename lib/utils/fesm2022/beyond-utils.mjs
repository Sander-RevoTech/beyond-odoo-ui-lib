...
export { APPLICATION_CONFIG, BydAbstractComponent, BydBaseComponent, BydBaseModal, BydBasePage, Civility, EFileExtension, FileSizePipe, HandleEntity, HorizontalScroll, JoinPipe, LetDirective, ObjectKeys, ObjectKeysReOrder, OnRenderDirective, PluralTranslatePipe, RequestState, SafePipe, StopPropagationDirective, SubscriberHandler, TemporaryFile, TimeAgoDirective, TranslatePipe, TypedTemplateDirective, call, capitalizeFirstLetter, compare, compareHour, convertToNumber, copyTextToClipboard, createRange, diffInHourAndMinutes, extractEnum, getFileExtension, getFirstNumber, getFirstString, getFullFileNameFromUrl, getPropertyTypes, getUniqueArray, getUniqueValues, isLight, isNonNullable, isURL, isValidEmail, keepUniqueObjectByProperty, merge, newGuid, newId, openMap, percentage, removeElement, removeElementsWithSameProperty, roundToDecimal, s4, sendMail, sort, toArray, toLocalDate, toLocalDateString, toUtcDate, trigram };
