...
class BydTranslationService {
    ...
    constructor(_config = {
        ...
        this._registry.newRegistrationSubscription$.pipe(debounceTime(500), mergeMap(() => this.translateService.reloadLang(this.translateService.currentLang))).subscribe({
