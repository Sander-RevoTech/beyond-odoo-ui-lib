...
export declare class BydTranslationService {
    private _config;
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<BydTranslationService, [{ optional: true; }]>;
    static ɵprov: i0.ɵɵInjectableDeclaration<BydTranslationService>;
}
