...
class WarehouseComponent extends BydAbstractComponent {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "19.2.1", type: WarehouseComponent, isStandalone: true, selector: "byd-warehouse", usesInheritance: true, ngImport: i0, template: "<div>\r\n  @for (warehouse of this.warehouses$ | async; track warehouse.id) {\r\n    <div class=\"warehouse-item\">\r\n      <h3>{{ warehouse.name }}</h3>\r\n      <button (click)=\"this.select(warehouse.id)\">select</button>\r\n    </div>\r\n  }\r\n</div>\r\n", styles: [""], dependencies: [{ kind: "pipe", type: AsyncPipe, name: "async" }] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.1", ngImport: i0, type: WarehouseComponent, decorators: [{
            type: Component,
            args: [{ selector: 'byd-warehouse', imports: [AsyncPipe], standalone: true, template: "<div>\r\n  @for (warehouse of this.warehouses$ | async; track warehouse.id) {\r\n    <div class=\"warehouse-item\">\r\n      <h3>{{ warehouse.name }}</h3>\r\n      <button (click)=\"this.select(warehouse.id)\">select</button>\r\n    </div>\r\n  }\r\n</div>\r\n" }]
        }], ctorParameters: () => [] });
