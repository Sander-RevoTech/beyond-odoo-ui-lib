...
import { InputCheckBox, InputEmail, InputPanel, InputPassword } from '@beyond/form-model';
...
import { BydAbstractComponent, BydBaseComponent, isNonNullable } from '@beyond/utils';
...
class GuardComponent extends BydAbstractComponent {
  ...
  static ɵcmp = i0.ɵɵngDeclareComponent({
    ...
    isStandalone: true,
    selector: 'byd-guard',
    inputs: { level: 'level', feature: 'feature', canDisplayErrorMessage: 'canDisplayErrorMessage' },
    usesInheritance: true,
    ngImport: i0,
    template:
...
class BydLoginPage {
  ...
  static ɵcmp = i0.ɵɵngDeclareComponent({
    ...
    ngImport: i0,
    template: '<byd-login-card></byd-login-card>\r\n',
    styles: [''],
    dependencies: [{ kind: 'component', type: LoginCardComponent, selector: 'byd-login-card' }],
  });
}
i0.ɵɵngDeclareClassMetadata({
  minVersion: '12.0.0',
