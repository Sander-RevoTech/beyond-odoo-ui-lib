...
import { BydAuthOdooService, BydCompaniesService, BydBaseOdooService, BydEmployeeService, BydWorkcentersService, BydWarehousesService } from '@beyond/odoo';
...
import { startWith, map, BehaviorSubject, debounceTime, mergeMap, of, filter, switchMap, tap } from 'rxjs';
import { Validators } from '@angular/forms';
import { InputCheckBox, InputPanel, InputTextBox, InputPassword } from '@beyond/form-model';
...
class AppUserFormService {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: AppUserFormService, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: AppUserFormService, providedIn: 'root' });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: AppUserFormService, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root',
                }]
...
class LoginCardComponent extends BydBaseComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: LoginCardComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "19.2.15", type: LoginCardComponent, isStandalone: true, selector: "byd-login-card", host: { listeners: { "document:keydown.enter": "handleEnter($event)" } }, usesInheritance: true, ngImport: i0, template: "<byd-loader [isLoading]=\"this.requestState.isLoading()\">\r\n  <byd-form [inputs]=\"this.form()\" [askValidation$]=\"this.askValidation$\" (valid)=\"this.login($event)\"></byd-form>\r\n</byd-loader>\r\n", styles: [""], dependencies: [{ kind: "component", type: LoaderComponent, selector: "byd-loader", inputs: ["isLoading", "skeleton"] }, { kind: "component", type: BydFormComponent, selector: "byd-form", inputs: ["inputs", "askValidation$", "askOnDestroy", "loader", "error", "border", "canDisplayButton", "buttonTitle", "onLive"], outputs: ["valid", "isFormValid"] }] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: LoginCardComponent, decorators: [{
            type: Component,
...
class GuardComponent extends BydAbstractComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: GuardComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "19.2.15", type: GuardComponent, isStandalone: true, selector: "byd-guard", inputs: { level: "level", feature: "feature", canDisplayErrorMessage: "canDisplayErrorMessage" }, usesInheritance: true, ngImport: i0, template: "<div class=\"guard\">\r\n  @if (this.isGuardValid()) {\r\n    <div class=\"guard-valid\">\r\n      <ng-content></ng-content>\r\n    </div>\r\n  } @else if (!this.isGuardValid() && this.canDisplayErrorMessage) {\r\n    <div class=\"guard-no-valid ta-c\">\r\n      <!-- <cam-font-icon name=\"close-tool\" size=\"md\"></cam-font-icon> -->\r\n      {{ 'container.guard.content' }}\r\n\r\n      @if (this.level === 'authenticated') {\r\n        <byd-button (action)=\"this.goToLogin()\"> Me connecter </byd-button>\r\n      }\r\n    </div>\r\n  }\r\n</div>\r\n", styles: [""], dependencies: [{ kind: "component", type: BydButtonComponent, selector: "byd-button", inputs: ["state", "type", "size", "icon", "options", "stopPropagationActivation"], outputs: ["action"] }] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: GuardComponent, decorators: [{
            type: Component,
...
class BydUserService extends BydBaseOdooService {
    ...
    workcentersServices = inject(BydWorkcentersService);
    openDialog = inject(MatDialog);
    constructor() {
        super();
        this.permissionsServices.updated$
            .pipe(debounceTime(50), mergeMap(() => this.fetchProfile$()))
            .subscribe();
    }
    fetchProfile$() {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydUserService, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydUserService, providedIn: 'root' });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydUserService, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root',
                }]
...
class WarehouseComponent extends BydAbstractComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: WarehouseComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "19.2.15", type: WarehouseComponent, isStandalone: true, selector: "byd-warehouse", usesInheritance: true, ngImport: i0, template: "@let warehouses = this.warehouses$ | async;\r\n\r\n<byd-loader [isLoading]=\"this.requestState.isLoading()\">\r\n  <div class=\"p-space-lg\">\r\n    <byd-empty [isEmpty]=\"!warehouses || warehouses.length === 0\" text=\"No warehouse are allow for your user\">\r\n      <div class=\"flex-column g-space-md\">\r\n        @for (warehouse of warehouses; track warehouse.id) {\r\n          <byd-card (click)=\"this.select(warehouse.id)\">\r\n            <byd-card-header>\r\n              <byd-card-title>\r\n                <h3>{{ warehouse.name }}</h3>\r\n              </byd-card-title>\r\n            </byd-card-header>\r\n          </byd-card>\r\n        }\r\n      </div>\r\n    </byd-empty>\r\n  </div>\r\n</byd-loader>\r\n", styles: [""], dependencies: [{ kind: "pipe", type: AsyncPipe, name: "async" }, { kind: "component", type: CardComponent, selector: "byd-card", inputs: ["highlight", "shadow", "fullHeight", "noContent", "isNew", "type"], outputs: ["click"] }, { kind: "component", type: CardHeaderComponent, selector: "byd-card-header" }, { kind: "component", type: CardTitleComponent, selector: "byd-card-title" }, { kind: "component", type: LoaderComponent, selector: "byd-loader", inputs: ["isLoading", "skeleton"] }, { kind: "component", type: EmptyComponent, selector: "byd-empty", inputs: ["isEmpty", "isLight", "showMessage", "text", "type", "icon", "iconSize"] }] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: WarehouseComponent, decorators: [{
            type: Component,
...
class WarehouseGuardComponent extends BydAbstractComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: WarehouseGuardComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "19.2.15", type: WarehouseGuardComponent, isStandalone: true, selector: "byd-warehouse-guard", usesInheritance: true, ngImport: i0, template: '', isInline: true });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: WarehouseGuardComponent, decorators: [{
            type: Component,
            args: [{
...
class BydLoginPage {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydLoginPage, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "19.2.15", type: BydLoginPage, isStandalone: true, selector: "ng-component", ngImport: i0, template: "<byd-login-card></byd-login-card>\r\n", styles: [""], dependencies: [{ kind: "component", type: LoginCardComponent, selector: "byd-login-card" }] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydLoginPage, decorators: [{
            type: Component,
...
class AuthGuard {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: AuthGuard, deps: [{ token: i1.Router }], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: AuthGuard, providedIn: 'root' });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: AuthGuard, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root',
                }]
...
class FeatureGuard {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: FeatureGuard, deps: [{ token: i1.Router }], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: FeatureGuard, providedIn: 'root' });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: FeatureGuard, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root',
                }]
