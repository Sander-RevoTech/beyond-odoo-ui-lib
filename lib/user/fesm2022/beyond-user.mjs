...
import { LoaderComponent, BydButtonComponent, CardComponent, CardHeaderComponent, CardTitleComponent } from '@beyond/ui';
...
import { startWith, map, debounceTime, mergeMap, of, filter, switchMap, tap } from 'rxjs';
...
class CompanyComponent extends BydAbstractComponent {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "19.2.1", type: CompanyComponent, isStandalone: true, selector: "byd-company", usesInheritance: true, ngImport: i0, template: "<div class=\"p-space-lg flex-column g-space-md\">\r\n  @for (company of this.companies$ | async; track company.id) {\r\n    <byd-card (click)=\"this.select(company.id)\">\r\n      <byd-card-header>\r\n        <byd-card-title>\r\n          <h3>{{ company.name }}</h3>\r\n        </byd-card-title>\r\n      </byd-card-header>\r\n    </byd-card>\r\n  }\r\n</div>\r\n", styles: [""], dependencies: [{ kind: "pipe", type: AsyncPipe, name: "async" }, { kind: "component", type: CardComponent, selector: "byd-card", inputs: ["highlight", "shadow", "fullHeight", "noContent", "isNew", "type"], outputs: ["click"] }, { kind: "component", type: CardHeaderComponent, selector: "byd-card-header" }, { kind: "component", type: CardTitleComponent, selector: "byd-card-title" }] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.1", ngImport: i0, type: CompanyComponent, decorators: [{
            type: Component,
            args: [{ selector: 'byd-company', imports: [AsyncPipe, CardComponent, CardHeaderComponent, CardTitleComponent], standalone: true, template: "<div class=\"p-space-lg flex-column g-space-md\">\r\n  @for (company of this.companies$ | async; track company.id) {\r\n    <byd-card (click)=\"this.select(company.id)\">\r\n      <byd-card-header>\r\n        <byd-card-title>\r\n          <h3>{{ company.name }}</h3>\r\n        </byd-card-title>\r\n      </byd-card-header>\r\n    </byd-card>\r\n  }\r\n</div>\r\n" }]
        }], ctorParameters: () => [] });
    ...
    fetchProfile$() {
        ...
        return this.profile.fetch(this._odooService
            ...
            if (!profile.share) {
                ...
                return this.employeesServices.getRelatedByUserId$(profile.id).pipe(tap(employee => this.permissionsServices.setEmployee(employee.id)), map(() => profile));
            }
        }), switchMap(profile => {
...
class WarehouseComponent extends BydAbstractComponent {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "19.2.1", type: WarehouseComponent, isStandalone: true, selector: "byd-warehouse", usesInheritance: true, ngImport: i0, template: "<div class=\"p-space-lg flex-column g-space-md\">\r\n  @for (warehouse of this.warehouses$ | async; track warehouse.id) {\r\n    <byd-card (click)=\"this.select(warehouse.id)\">\r\n      <byd-card-header>\r\n        <byd-card-title>\r\n          <h3>{{ warehouse.name }}</h3>\r\n        </byd-card-title>\r\n      </byd-card-header>\r\n    </byd-card>\r\n  }\r\n</div>\r\n", styles: [""], dependencies: [{ kind: "pipe", type: AsyncPipe, name: "async" }, { kind: "component", type: CardComponent, selector: "byd-card", inputs: ["highlight", "shadow", "fullHeight", "noContent", "isNew", "type"], outputs: ["click"] }, { kind: "component", type: CardHeaderComponent, selector: "byd-card-header" }, { kind: "component", type: CardTitleComponent, selector: "byd-card-title" }] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.1", ngImport: i0, type: WarehouseComponent, decorators: [{
            type: Component,
            args: [{ selector: 'byd-warehouse', imports: [AsyncPipe, CardComponent, CardHeaderComponent, CardTitleComponent], standalone: true, template: "<div class=\"p-space-lg flex-column g-space-md\">\r\n  @for (warehouse of this.warehouses$ | async; track warehouse.id) {\r\n    <byd-card (click)=\"this.select(warehouse.id)\">\r\n      <byd-card-header>\r\n        <byd-card-title>\r\n          <h3>{{ warehouse.name }}</h3>\r\n        </byd-card-title>\r\n      </byd-card-header>\r\n    </byd-card>\r\n  }\r\n</div>\r\n" }]
        }], ctorParameters: () => [] });
