...
import { BydAuthOdooService, BydBaseOdooService, BydEmployeeService, BydWarehousesService } from '@beyond/odoo';
...
class WarehouseComponent extends BydAbstractComponent {
    ...
    warehouses$ = this._warehouseServices.warehouse.get$();
    constructor() {
        super();
