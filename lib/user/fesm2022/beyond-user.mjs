...
import { startWith, map, mergeMap, of, filter, tap } from 'rxjs';
...
class BydUserService extends BydBaseOdooService {
    ...
    fetchProfile$() {
        ...
        return this.profile$.fetch(this._odooService
            .searchRead$('res.users', [['id', '=', this.permissionsServices.uid]], ['id', 'email', 'display_name', 'share', 'groups_id', 'employee_id', 'company_id', 'company_ids'])
