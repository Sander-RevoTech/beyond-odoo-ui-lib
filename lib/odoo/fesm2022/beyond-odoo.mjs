...
class BydEmployeeService extends BydBaseOdooService {
    ...
    getWorkcenters$(id) {
        return this.permissionsServices.updated$.pipe(switchMap(() => this._odooService.searchRead$('hr.employee', [['id', '=', id]], ['id', 'workcenter_ids']).pipe(filter$1(data => !!data), map$1(data => data[0]?.workcenter_ids || []))));
    }
