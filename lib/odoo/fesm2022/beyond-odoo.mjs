...
export { AppMessagesService, BydAuthOdooService, BydBaseOdooService, BydEmployeeService, BydMessagesComponent, BydScanPackingComponent, BydScanPackingService, BydUploadComponent, ContainerComponent, ODOO_SERVER_CONFIG_KEY, TargetUrlInterceptor, provideOdoo };
