...
import { getFirstString, getBase64FromFile, takeImage, picImages, BydBaseComponent, getFirstNumber } from '@beyond/utils';
import { map, catchError, of, tap, Subject, BehaviorSubject, filter, forkJoin, mergeMap } from 'rxjs';
...
class ScanningComponent extends BydBaseComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.1", ngImport: i0, type: ScanningComponent, deps: null, target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "19.2.1", type: ScanningComponent, isStandalone: true, selector: "byd-scanning", outputs: { scanSuccess: "scanSuccess", error: "error" }, usesInheritance: true, ngImport: i0, template: "<zxing-scanner\r\n  (scanSuccess)=\"this.scanSuccess.emit($event)\"\r\n  (permissionResponse)=\"this.permissionResponse($event)\"\r\n></zxing-scanner>\r\n", styles: [""], dependencies: [{ kind: "ngmodule", type: ZXingScannerModule }, { kind: "component", type: i1.ZXingScannerComponent, selector: "zxing-scanner", inputs: ["autofocusEnabled", "timeBetweenScans", "delayBetweenScanSuccess", "autostart", "previewFitMode", "poster", "device", "formats", "videoConstraints", "torch", "enable", "tryHarder"], outputs: ["autostarted", "autostarting", "torchCompatible", "scanSuccess", "scanFailure", "scanError", "scanComplete", "camerasFound", "camerasNotFound", "permissionResponse", "hasDevices", "deviceChange"] }] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.1", ngImport: i0, type: ScanningComponent, decorators: [{
            type: Component,
            args: [{ selector: 'byd-scanning', imports: [ZXingScannerModule], template: "<zxing-scanner\r\n  (scanSuccess)=\"this.scanSuccess.emit($event)\"\r\n  (permissionResponse)=\"this.permissionResponse($event)\"\r\n></zxing-scanner>\r\n" }]
...
export { BydAttachementsService, BydAuthOdooService, BydBaseOdooService, BydEmployeeService, BydMessagesComponent, BydMessagesService, BydPartnersService, BydPrinterService, BydScanPackingComponent, BydScanPackingService, BydUploadComponent, BydWarehousesService, ContainerComponent, ODOO_SERVER_CONFIG_KEY, ScanningComponent, TargetUrlInterceptor, provideOdoo };
