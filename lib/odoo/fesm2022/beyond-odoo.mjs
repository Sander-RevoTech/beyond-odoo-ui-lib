...
import { BydButtonComponent, LoaderComponent, ErrorComponent, EmptyComponent, CardComponent, CardHeaderComponent, CardTitleComponent } from '@beyond/ui';
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.1", ngImport: i0, type: ScanPackingDialog, decorators: [{
        ...
        }], ctorParameters: () => [{ type: i1.MatDialogRef }], propDecorators: { scopes: [{
                type: Input
            }] } });
...
class BydScanPackingComponent extends BydBaseComponent {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "19.2.1", type: BydScanPackingComponent, isStandalone: true, selector: "byd-scan-packing", usesInheritance: true, ngImport: i0, template: '', isInline: true });
}
...
export { AppMessagesService, BydAuthOdooService, BydBaseOdooService, BydMessagesComponent, BydScanPackingComponent, BydScanPackingService, BydUploadComponent, ODOO_SERVER_CONFIG_KEY, TargetUrlInterceptor, provideOdoo };
