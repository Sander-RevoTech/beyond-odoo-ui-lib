...
class OdooJsonConnector {
    ...
    searchRead$(model, domain, fields = [], opts = {}) {
        ...
        if (this.permissionsServices.compagnies &&
        ...
        const params = {
            ...
            params: {
                ...
                args: [
                    ...
                    method,
                    args,
                    { ...kwargs, ...{ context: { company_id: this.permissionsServices.compagnies } } },
                ],
            },
            id: new Date().getTime(),
        };
...
export { BydAttachementsService, BydAuthOdooService, BydBaseOdooService, BydEmployeeService, BydMessagesComponent, BydMessagesService, BydPartnersService, BydPrinterService, BydScanPackingComponent, BydScanPackingService, BydUploadComponent, ContainerComponent, ODOO_SERVER_CONFIG_KEY, TargetUrlInterceptor, provideOdoo };
