...
import { InjectionToken, inject, Injectable, signal, Input, Component, EventEmitter, Output, Inject } from '@angular/core';
...
import { LoaderComponent, ErrorComponent, BydButtonComponent, EmptyComponent, CardComponent, CardHeaderComponent, CardTitleComponent, CardCtaComponent, BydTitleComponent } from '@beyond/ui';
...
class OdooJsonConnector {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: OdooJsonConnector, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: OdooJsonConnector, providedIn: 'root' });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: OdooJsonConnector, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root',
                }]
...
class BydBaseOdooService {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydBaseOdooService, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydBaseOdooService, providedIn: 'root' });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydBaseOdooService, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root',
                }]
...
class BydAttachementsService extends BydBaseOdooService {
    attachmentsByIds = new HandleComplexRequest();
    ...
    fetchByIds$(ids) {
        return this.attachmentsByIds.fetch(this.keyByIds(ids), this._odooService
            .searchRead$('ir.attachment', [['id', 'in', ids]], ['id', 'datas'])
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydAttachementsService, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydAttachementsService, providedIn: 'root' });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydAttachementsService, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root',
                }]
...
class BydMessagesService extends BydBaseOdooService {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydMessagesService, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydMessagesService, providedIn: 'root' });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydMessagesService, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root',
                }]
...
class BydImagesComponent extends BydBaseComponent {
    ids;
    _attachementsService = inject(BydAttachementsService);
    images = signal(null);
    constructor() {
        super();
    }
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydImagesComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "19.2.15", type: BydImagesComponent, isStandalone: true, selector: "byd-images", inputs: { ids: "ids" }, usesInheritance: true, ngImport: i0, template: "<byd-loader [isLoading]=\"this.requestState.isLoading()\">\r\n  <byd-error [message]=\"this.requestState.getErrorMessage()\" [code]=\"this.requestState.getErrorStatus()\">\r\n    <div class=\"grid\">\r\n      @if (this.images()) {\r\n        @for (image of this.images() | async; track image.id) {\r\n          <div class=\"g-col-3\">\r\n            <img [src]=\"'data:image/jpeg;base64,' + image.datas\" width=\"100%\" />\r\n          </div>\r\n        }\r\n      }\r\n    </div>\r\n  </byd-error>\r\n</byd-loader>\r\n", styles: [".item-message{margin:5px 0;padding:5px;border:1px solid var(--byd-surface-brand-primary);border-radius:5px}\n"], dependencies: [{ kind: "component", type: LoaderComponent, selector: "byd-loader", inputs: ["isLoading", "skeleton"] }, { kind: "component", type: ErrorComponent, selector: "byd-error", inputs: ["message", "code"] }, { kind: "pipe", type: AsyncPipe, name: "async" }] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydImagesComponent, decorators: [{
            type: Component,
            args: [{ selector: 'byd-images', standalone: true, imports: [LoaderComponent, ErrorComponent, AsyncPipe], template: "<byd-loader [isLoading]=\"this.requestState.isLoading()\">\r\n  <byd-error [message]=\"this.requestState.getErrorMessage()\" [code]=\"this.requestState.getErrorStatus()\">\r\n    <div class=\"grid\">\r\n      @if (this.images()) {\r\n        @for (image of this.images() | async; track image.id) {\r\n          <div class=\"g-col-3\">\r\n            <img [src]=\"'data:image/jpeg;base64,' + image.datas\" width=\"100%\" />\r\n          </div>\r\n        }\r\n      }\r\n    </div>\r\n  </byd-error>\r\n</byd-loader>\r\n", styles: [".item-message{margin:5px 0;padding:5px;border:1px solid var(--byd-surface-brand-primary);border-radius:5px}\n"] }]
        }], ctorParameters: () => [], propDecorators: { ids: [{
                type: Input
            }] } });

class BydUploadAnnotationDialog {
    ...
    imagePath = this.data.file ? URL.createObjectURL(this.data.file) : this.data.localUrl;
    constructor() {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydUploadAnnotationDialog, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "19.2.15", type: BydUploadAnnotationDialog, isStandalone: true, selector: "ng-component", ngImport: i0, template: "<div class=\"close-dialog\" mat-button mat-dialog-close>\r\n  <mat-icon>close</mat-icon>\r\n</div>\r\n@if (this.imagePath) {\r\n  <byd-files-annotation\r\n    [imagePath]=\"this.imagePath\"\r\n    [style.height.%]=\"100\"\r\n    [style.width.%]=\"100\"\r\n    (savedImage)=\"this.savedImage($event)\"\r\n  ></byd-files-annotation>\r\n}\r\n", dependencies: [{ kind: "component", type: FilesAnnotationComponent, selector: "byd-files-annotation", inputs: ["imagePath", "saveImage$"], outputs: ["savedImage"] }, { kind: "component", type: MatIcon, selector: "mat-icon", inputs: ["color", "inline", "svgIcon", "fontSet", "fontIcon"], exportAs: ["matIcon"] }, { kind: "directive", type: MatDialogClose, selector: "[mat-dialog-close], [matDialogClose]", inputs: ["aria-label", "type", "mat-dialog-close", "matDialogClose"], exportAs: ["matDialogClose"] }] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydUploadAnnotationDialog, decorators: [{
            type: Component,
            args: [{ selector: '', standalone: true, imports: [FilesAnnotationComponent, MatIcon, MatDialogClose], template: "<div class=\"close-dialog\" mat-button mat-dialog-close>\r\n  <mat-icon>close</mat-icon>\r\n</div>\r\n@if (this.imagePath) {\r\n  <byd-files-annotation\r\n    [imagePath]=\"this.imagePath\"\r\n    [style.height.%]=\"100\"\r\n    [style.width.%]=\"100\"\r\n    (savedImage)=\"this.savedImage($event)\"\r\n  ></byd-files-annotation>\r\n}\r\n" }]
        }], ctorParameters: () => [] });
...
class BydUploadComponent extends BydBaseComponent {
    ...
    openAnnotation(pic) {
        this._dialog
            .open(BydUploadAnnotationDialog, {
            data: pic,
        })
            .afterClosed()
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydUploadComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "19.2.15", type: BydUploadComponent, isStandalone: true, selector: "byd-files-upload", inputs: { features: "features", canSelectMultipleFiles: "canSelectMultipleFiles", clear$: "clear$", enableEdit: "enableEdit" }, outputs: { filesPicked: "filesPicked" }, usesInheritance: true, ngImport: i0, template: "<div class=\"mb-space-md\">\r\n  <div class=\"grid align-items-center mb-space-xs\">\r\n    @for (pic of this.tempImages(); track pic) {\r\n      <div class=\"temp-pic-container g-col-3\">\r\n        <img [src]=\"pic.localUrl\" width=\"100%\" />\r\n        <div class=\"remove-cta\" (click)=\"this.remove(pic)\">\r\n          <mat-icon>close</mat-icon>\r\n        </div>\r\n        @if (this.enableEdit) {\r\n          <div>\r\n            <byd-button (action)=\"this.openAnnotation(pic)\"> Edit </byd-button>\r\n          </div>\r\n        }\r\n      </div>\r\n    }\r\n  </div>\r\n  <byd-loader [isLoading]=\"this.requestState.isLoading()\"> </byd-loader>\r\n  <div>\r\n    @if (this.addActions.length === 1) {\r\n      <byd-button (action)=\"this.addActions[0].callback()\">\r\n        <mat-icon>{{ this.addActions[0].icon | translate }}</mat-icon>\r\n      </byd-button>\r\n    } @else if (this.addActions.length > 1) {\r\n      <div class=\"flex-start g-space-lg\">\r\n        @for (action of this.addActions; track action.label) {\r\n          <byd-button (action)=\"action.callback()\">\r\n            <mat-icon>{{ action.icon }}</mat-icon>\r\n          </byd-button>\r\n        }\r\n      </div>\r\n    }\r\n  </div>\r\n</div>\r\n", styles: [".temp-pic-container{position:relative;padding:2px}.remove-cta{position:absolute;top:0;right:2px;background-color:var(--byd-semantic-token-alert)}\n"], dependencies: [{ kind: "component", type: BydButtonComponent, selector: "byd-button", inputs: ["state", "type", "size", "icon", "options", "stopPropagationActivation"], outputs: ["action"] }, { kind: "component", type: MatIcon, selector: "mat-icon", inputs: ["color", "inline", "svgIcon", "fontSet", "fontIcon"], exportAs: ["matIcon"] }, { kind: "pipe", type: TranslatePipe, name: "translate" }, { kind: "component", type: LoaderComponent, selector: "byd-loader", inputs: ["isLoading", "skeleton"] }] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydUploadComponent, decorators: [{
            type: Component,
            args: [{ selector: 'byd-files-upload', standalone: true, imports: [BydButtonComponent, MatIcon, TranslatePipe, LoaderComponent], template: "<div class=\"mb-space-md\">\r\n  <div class=\"grid align-items-center mb-space-xs\">\r\n    @for (pic of this.tempImages(); track pic) {\r\n      <div class=\"temp-pic-container g-col-3\">\r\n        <img [src]=\"pic.localUrl\" width=\"100%\" />\r\n        <div class=\"remove-cta\" (click)=\"this.remove(pic)\">\r\n          <mat-icon>close</mat-icon>\r\n        </div>\r\n        @if (this.enableEdit) {\r\n          <div>\r\n            <byd-button (action)=\"this.openAnnotation(pic)\"> Edit </byd-button>\r\n          </div>\r\n        }\r\n      </div>\r\n    }\r\n  </div>\r\n  <byd-loader [isLoading]=\"this.requestState.isLoading()\"> </byd-loader>\r\n  <div>\r\n    @if (this.addActions.length === 1) {\r\n      <byd-button (action)=\"this.addActions[0].callback()\">\r\n        <mat-icon>{{ this.addActions[0].icon | translate }}</mat-icon>\r\n      </byd-button>\r\n    } @else if (this.addActions.length > 1) {\r\n      <div class=\"flex-start g-space-lg\">\r\n        @for (action of this.addActions; track action.label) {\r\n          <byd-button (action)=\"action.callback()\">\r\n            <mat-icon>{{ action.icon }}</mat-icon>\r\n          </byd-button>\r\n        }\r\n      </div>\r\n    }\r\n  </div>\r\n</div>\r\n", styles: [".temp-pic-container{position:relative;padding:2px}.remove-cta{position:absolute;top:0;right:2px;background-color:var(--byd-semantic-token-alert)}\n"] }]
...
class BydScanPackingService extends BydBaseOdooService {
    ...
    lookForPacking$(model, id) {
        return this._odooService.action$(model, 'search_by_id', Number(id)).pipe(filter(data => !!data));
    }
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydScanPackingService, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydScanPackingService, providedIn: 'root' });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydScanPackingService, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root',
                }]
...
class ScanPackingDialog extends BydBaseComponent {
    ...
    scanSuccess(result) {
        ...
        const getSearch$ = getSearchScope && getSearchScope.search
...
class BydScanPackingComponent extends BydBaseComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydScanPackingComponent, deps: [{ token: i1$1.MatDialog }], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "19.2.15", type: BydScanPackingComponent, isStandalone: true, selector: "byd-scan-packing", inputs: { scopes: "scopes" }, usesInheritance: true, ngImport: i0, template: '', isInline: true });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydScanPackingComponent, decorators: [{
            type: Component,
            args: [{
...
class BydPrinterService extends BydBaseOdooService {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydPrinterService, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydPrinterService, providedIn: 'root' });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydPrinterService, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root',
                }]
...
class BydPrinterFormService {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydPrinterFormService, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydPrinterFormService, providedIn: 'root' });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydPrinterFormService, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root',
                }]
...
class ContainerComponent extends BydBaseComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: ContainerComponent, deps: [{ token: i1$1.MatDialog }], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "19.2.15", type: ContainerComponent, isStandalone: true, selector: "byd-printer-container", usesInheritance: true, ngImport: i0, template: '', isInline: true });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: ContainerComponent, decorators: [{
            type: Component,
            args: [{
...
class TargetUrlInterceptor {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: TargetUrlInterceptor, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: TargetUrlInterceptor });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: TargetUrlInterceptor, decorators: [{
            type: Injectable
        }], ctorParameters: () => [] });
...
class BydAuthOdooService extends BydBaseOdooService {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydAuthOdooService, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydAuthOdooService, providedIn: 'root' });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydAuthOdooService, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root',
                }]
...
class BydEmployeeService extends BydBaseOdooService {
    ...
    getWorkcenters$(id) {
        return this._odooService.searchRead$('hr.employee', [['id', '=', id]], ['id', 'workcenter_ids']).pipe(filter$1(data => !!data), map$1(data => data[0]?.workcenter_ids || []));
    }
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydEmployeeService, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydEmployeeService, providedIn: 'root' });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydEmployeeService, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root',
                }]
...
class BydPartnersService extends BydBaseOdooService {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydPartnersService, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydPartnersService, providedIn: 'root' });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydPartnersService, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root',
                }]
...
class BydWarehousesService extends BydBaseOdooService {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydWarehousesService, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydWarehousesService, providedIn: 'root' });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydWarehousesService, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root',
                }]
...
class BydCompaniesService extends BydBaseOdooService {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydCompaniesService, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydCompaniesService, providedIn: 'root' });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydCompaniesService, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root',
                }]
...
class BydWorkcentersService extends BydBaseOdooService {
    workcenters = new HandleSimpleRequest();
    workcenter = new HandleSimpleRequest();
    constructor() {
        super();
    }
    fetch$(ids, warehouseId) {
        return this.workcenters.fetch(this._odooService
            .searchRead$('mrp.workcenter', [
            ['id', 'in', ids],
    ...
    get$(id) {
        return this.workcenter.fetch(this._odooService.searchRead$('mrp.workcenter', [['id', '=', id]], ['id', 'name']).pipe(filter$1(data => !!data), map$1(data => data[0])));
    }
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydWorkcentersService, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydWorkcentersService, providedIn: 'root' });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydWorkcentersService, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root',
                }]
...
export { BydAttachementsService, BydAuthOdooService, BydBaseOdooService, BydCompaniesService, BydEmployeeService, BydMessagesComponent, BydMessagesService, BydPartnersService, BydPrinterService, BydScanPackingComponent, BydScanPackingService, BydScanningComponent, BydUploadComponent, BydWarehousesService, BydWorkcentersService, ContainerComponent, ODOO_SERVER_CONFIG_KEY, ScanPackingDialog, TargetUrlInterceptor, provideOdoo };
