...
import { getFirstString, getBase64FromFile, takeImage, picImages, BydBaseComponent, isNonNullable, getFirstNumber } from '@beyond/utils';
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.1", ngImport: i0, type: LabelModal, decorators: [{
            type: Component,
            args: [{ selector: '', standalone: true, imports: [LoaderComponent, ErrorComponent, BydTitleComponent, BydFormComponent, MatIcon, AsyncPipe], template: "@let wizard = this.wizard() | async;\r\n\r\n@if (wizard) {\r\n  <div class=\"p-space-md\">\r\n    <div class=\"close-dialog\" mat-button mat-dialog-close>\r\n      <mat-icon> close </mat-icon>\r\n    </div>\r\n    <byd-title [level]=\"2\" [isBold]=\"true\">{{ wizard.display_name }}</byd-title>\r\n    <byd-loader [isLoading]=\"this.requestState.isLoading()\">\r\n      <byd-error [message]=\"this.requestState.getErrorMessage()\" [code]=\"this.requestState.getErrorStatus()\">\r\n        @if (form) {\r\n          <byd-form [inputs]=\"form\" buttonTitle=\"print\" (valid)=\"this.print($event)\"></byd-form>\r\n        }\r\n      </byd-error>\r\n    </byd-loader>\r\n  </div>\r\n}\r\n" }]
        }], ctorParameters: () => [{ type: i1$1.MatDialogRef }, { type: undefined, decorators: [{
                    type: Inject,
                    args: [MAT_DIALOG_DATA]
                }] }] });
...
export { BydAttachementsService, BydAuthOdooService, BydBaseOdooService, BydEmployeeService, BydMessagesComponent, BydMessagesService, BydPartnersService, BydPrinterService, BydScanPackingComponent, BydScanPackingService, BydScanningComponent, BydUploadComponent, BydWarehousesService, ContainerComponent, ODOO_SERVER_CONFIG_KEY, TargetUrlInterceptor, provideOdoo };
