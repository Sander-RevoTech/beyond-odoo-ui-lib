...
class PanelComponent extends BydBaseComponent {
  ...
  static ɵcmp = i0.ɵɵngDeclareComponent({
    ...
    inputs: { inputsTemplate: 'inputsTemplate', panel: 'panel' },
    ...
    styles: [
      '.with-separator{border-bottom:1px solid #a9a9a9;padding-bottom:2em}.highlight-title .panel-title{color:var(--byd-surface-brand-primary);font-style:normal;font-weight:500;font-size:15px;line-height:24px;letter-spacing:.1em;text-transform:uppercase;padding-top:2em}.no-title-space .panel-title{padding-top:0}\n',
    ],
    dependencies: [
...
class InputsComponent extends BydBaseComponent {
  ...
  static ɵcmp = i0.ɵɵngDeclareComponent({
    ...
    dependencies: [
      ...
      { kind: 'directive', type: NgSwitch, selector: '[ngSwitch]', inputs: ['ngSwitch'] },
      { kind: 'directive', type: NgSwitchCase, selector: '[ngSwitchCase]', inputs: ['ngSwitchCase'] },
      {
        kind: 'component',
      ...
      { kind: 'component', type: TextareaComponent, selector: 'byd-input-textarea', inputs: ['input', 'matcher'] },
      {
        kind: 'component',
      ...
      { kind: 'component', type: RadioComponent, selector: 'byd-input-radio', inputs: ['input'] },
      { kind: 'component', type: CheckboxComponent, selector: 'byd-input-checkbox', inputs: ['input'] },
      { kind: 'component', type: ToggleComponent, selector: 'byd-input-toggle', inputs: ['input'] },
      { kind: 'component', type: PanelComponent, selector: 'byd-form-panel', inputs: ['inputsTemplate', 'panel'] },
      { kind: 'component', type: LabelComponent, selector: 'byd-input-label', inputs: ['input'] },
      { kind: 'component', type: InputChoicesComponent, selector: 'app-input-choices', inputs: ['input', 'matcher'] },
      { kind: 'component', type: BydInputButtonComponent, selector: 'byd-input-button', inputs: ['input'] },
    ],
  });
}
i0.ɵɵngDeclareClassMetadata({
...
class BydFormComponent extends BydBaseComponent {
  ...
  static ɵcmp = i0.ɵɵngDeclareComponent({
    ...
    inputs: {
      inputs: 'inputs',
      askValidation$: 'askValidation$',
      askOnDestroy: 'askOnDestroy',
      loader: 'loader',
      error: 'error',
      border: 'border',
    ...
    outputs: { valid: 'valid', isFormValid: 'isFormValid' },
    usesInheritance: true,
    usesOnChanges: true,
    ngImport: i0,
    template:
    ...
    styles: [''],
    dependencies: [
      { kind: 'component', type: InputsComponent, selector: 'byd-inputs', inputs: ['input', 'space'] },
      {
        kind: 'directive',
        type: NgFor,
        selector: '[ngFor][ngForOf]',
      ...
      { kind: 'directive', type: i1.ɵNgNoValidate, selector: 'form:not([ngNoForm]):not([ngNativeValidate])' },
      {
        kind: 'directive',
      ...
      {
        kind: 'component',
        type: NotificationInlineComponent,
        selector: 'byd-notification-inline',
        inputs: ['message', 'code', 'showClose'],
        outputs: ['askClose'],
      },
    ],
  });
