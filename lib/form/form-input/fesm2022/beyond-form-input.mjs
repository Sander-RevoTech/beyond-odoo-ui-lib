...
import { NgIf, NgFor, AsyncPipe, NgClass, NgTemplateOutlet } from '@angular/common';
...
import { BydTooltipComponent, BydBadgeComponent, CardComponent, CardContentComponent, BydButtonComponent } from '@beyond/ui';
...
import { Subject, debounceTime, mergeMap, filter, take } from 'rxjs';
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: FormLabelComponent, decorators: [{
            ...
            args: [{ selector: 'byd-form-label', standalone: true, imports: [
                        ...
                        TranslatePipe,
                        BydTooltipComponent,
                    ], template: "<div *ngIf=\"this.input.label\">\r\n  <mat-label>\r\n    {{ this.input.label | translate }}\r\n    <span *ngFor=\"let validator of this.input.validators\">\r\n      <span *ngIf=\"validator === validators.required\"> * </span>\r\n    </span>\r\n    @if (this.input.tooltip) {\r\n      <byd-tooltip [message]=\"this.input.tooltip\"></byd-tooltip>\r\n    }\r\n  </mat-label>\r\n</div>\r\n", styles: ["mat-label{display:block;font-size:var(--byd-font-body-sm-default-size);line-height:var(--byd-font-body-sm-default-line);font-weight:var(--byd-font-body-sm-default-weight);color:var(--byd-brand-700);margin-bottom:var(--byd-space-sm)}\n"] }]
...
class ChoicesBottomSheetComponent extends BydBadgeComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: ChoicesBottomSheetComponent, deps: [{ token: i1$2.MatBottomSheetRef }, { token: MAT_BOTTOM_SHEET_DATA }], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "19.2.15", type: ChoicesBottomSheetComponent, isStandalone: true, selector: "ng-component", usesInheritance: true, ngImport: i0, template: "<div class=\"search-container\">\n  <mat-form-field class=\"search-field\" appearance=\"outline\" subscriptSizing=\"dynamic\">\n    <mat-icon matPrefix>search</mat-icon>\n    <input\n      #box\n      matInput\n      [type]=\"'text'\"\n      (keyup)=\"this.searchValuechanged(box.value)\"\n    />\n  </mat-form-field>\n</div>\n<div class=\"options-list flex-column g-space-sm\">\n  @if (!this.data.input.choiceTemplate) {\n    <byd-card *ngFor=\"let item of this.options | async\" (click)=\"this.choice(item)\">\n      <byd-card-content>\n        {{ item.name }}\n      </byd-card-content>\n    </byd-card>\n  } @else if (this.data.input.choiceTemplate.one) {\n    <byd-card\n      *ngFor=\"let item of this.options | async\"\n      [class.is-selected]=\"this.isSelected(item)\"\n      (click)=\"this.choice(item)\"\n    >\n      <byd-card-content>\n        <ng-template\n          [ngTemplateOutlet]=\"this.data.input.choiceTemplate.one\"\n          [ngTemplateOutletContext]=\"{ item: item.data }\"\n        ></ng-template>\n      </byd-card-content>\n    </byd-card>\n  } @else if (this.data.input.choiceTemplate.list) {\n    <ng-template\n      [ngTemplateOutlet]=\"this.data.input.choiceTemplate.list\"\n      [ngTemplateOutletContext]=\"{\n        data: {\n          items: this.options | async,\n          isselected: this.isSelected,\n          select: this.choice,\n          search: this.currentSearch,\n          values: this.data.input.value,\n        }\n      }\"\n    ></ng-template>\n  }\n</div>\n", styles: [".search-container{padding:var(--byd-space-sm) var(--byd-space-md) 0}.search-container .search-field{width:100%}.options-list{padding:var(--byd-space-sm) var(--byd-space-md);padding-bottom:max(var(--byd-space-xl),env(safe-area-inset-bottom))}\n"], dependencies: [{ kind: "component", type: CardComponent, selector: "byd-card", inputs: ["highlight", "shadow", "fullHeight", "noContent", "isNew", "type"], outputs: ["click"] }, { kind: "component", type: CardContentComponent, selector: "byd-card-content" }, { kind: "pipe", type: AsyncPipe, name: "async" }, { kind: "directive", type: NgFor, selector: "[ngFor][ngForOf]", inputs: ["ngForOf", "ngForTrackBy", "ngForTemplate"] }, { kind: "directive", type: NgTemplateOutlet, selector: "[ngTemplateOutlet]", inputs: ["ngTemplateOutletContext", "ngTemplateOutlet", "ngTemplateOutletInjector"] }, { kind: "ngmodule", type: MatFormFieldModule }, { kind: "component", type: i1.MatFormField, selector: "mat-form-field", inputs: ["hideRequiredMarker", "color", "floatLabel", "appearance", "subscriptSizing", "hintLabel"], exportAs: ["matFormField"] }, { kind: "directive", type: i1.MatPrefix, selector: "[matPrefix], [matIconPrefix], [matTextPrefix]", inputs: ["matTextPrefix"] }, { kind: "ngmodule", type: MatInputModule }, { kind: "directive", type: i2$1.MatInput, selector: "input[matInput], textarea[matInput], select[matNativeControl],      input[matNativeControl], textarea[matNativeControl]", inputs: ["disabled", "id", "placeholder", "name", "required", "type", "errorStateMatcher", "aria-describedby", "value", "readonly", "disabledInteractive"], exportAs: ["matInput"] }, { kind: "ngmodule", type: MatIconModule }, { kind: "component", type: i2$2.MatIcon, selector: "mat-icon", inputs: ["color", "inline", "svgIcon", "fontSet", "fontIcon"], exportAs: ["matIcon"] }] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: ChoicesBottomSheetComponent, decorators: [{
            type: Component,
            args: [{ selector: '', standalone: true, imports: [CardComponent, CardContentComponent, AsyncPipe, NgFor, NgTemplateOutlet, MatFormFieldModule, MatInputModule, MatIconModule], template: "<div class=\"search-container\">\n  <mat-form-field class=\"search-field\" appearance=\"outline\" subscriptSizing=\"dynamic\">\n    <mat-icon matPrefix>search</mat-icon>\n    <input\n      #box\n      matInput\n      [type]=\"'text'\"\n      (keyup)=\"this.searchValuechanged(box.value)\"\n    />\n  </mat-form-field>\n</div>\n<div class=\"options-list flex-column g-space-sm\">\n  @if (!this.data.input.choiceTemplate) {\n    <byd-card *ngFor=\"let item of this.options | async\" (click)=\"this.choice(item)\">\n      <byd-card-content>\n        {{ item.name }}\n      </byd-card-content>\n    </byd-card>\n  } @else if (this.data.input.choiceTemplate.one) {\n    <byd-card\n      *ngFor=\"let item of this.options | async\"\n      [class.is-selected]=\"this.isSelected(item)\"\n      (click)=\"this.choice(item)\"\n    >\n      <byd-card-content>\n        <ng-template\n          [ngTemplateOutlet]=\"this.data.input.choiceTemplate.one\"\n          [ngTemplateOutletContext]=\"{ item: item.data }\"\n        ></ng-template>\n      </byd-card-content>\n    </byd-card>\n  } @else if (this.data.input.choiceTemplate.list) {\n    <ng-template\n      [ngTemplateOutlet]=\"this.data.input.choiceTemplate.list\"\n      [ngTemplateOutletContext]=\"{\n        data: {\n          items: this.options | async,\n          isselected: this.isSelected,\n          select: this.choice,\n          search: this.currentSearch,\n          values: this.data.input.value,\n        }\n      }\"\n    ></ng-template>\n  }\n</div>\n", styles: [".search-container{padding:var(--byd-space-sm) var(--byd-space-md) 0}.search-container .search-field{width:100%}.options-list{padding:var(--byd-space-sm) var(--byd-space-md);padding-bottom:max(var(--byd-space-xl),env(safe-area-inset-bottom))}\n"] }]
...
class BydInputChoicesComponent extends BydAbstractComponent {
    ...
    ngOnInit() {
        ...
        const source$ = this.input.advancedSearch$
            ...
            : this.input.options;
        this._registerSubscription(source$
            .pipe(filter(options => options.length > 0), take(1))
            .subscribe(options => {
...
class BydInputButtonComponent {
    input;
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydInputButtonComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "19.2.15", type: BydInputButtonComponent, isStandalone: true, selector: "byd-input-button", inputs: { input: "input" }, ngImport: i0, template: "<byd-button\r\n  (action)=\"this.input.callback()\"\r\n  [state]=\"(this.input.disabled$ | async) ? 'disabled' : 'classic'\"\r\n  [type]=\"this.input.style\"\r\n>\r\n  {{ this.input.label | translate }}\r\n</byd-button>\r\n", styles: [""], dependencies: [{ kind: "component", type: BydButtonComponent, selector: "byd-button", inputs: ["state", "type", "size", "icon", "options", "stopPropagationActivation"], outputs: ["action"] }, { kind: "pipe", type: TranslatePipe, name: "translate" }, { kind: "pipe", type: AsyncPipe, name: "async" }] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydInputButtonComponent, decorators: [{
            type: Component,
