...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.1", ngImport: i0, type: LabelComponent, decorators: [{
            type: Component,
            args: [{ selector: 'byd-input-label', standalone: true, imports: [MatFormFieldModule, MatInputModule, FormsModule, ReactiveFormsModule, TranslatePipe, AsyncPipe
                    ], template: "<span>{{ input.label | translate }}</span>\n<span>{{ input.extraInfo | async }}</span>\n" }]
        }], ctorParameters: () => [], propDecorators: { input: [{
                type: Input
            }] } });
