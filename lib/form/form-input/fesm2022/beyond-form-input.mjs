...
class InputChoicesComponent extends BydAbstractComponent {
    _bottomSheet;
    input;
    matcher;
    validators = Validators;
...
export { BydDatePickerComponent, BydInputButtonComponent, CheckboxComponent, DropdownComponent, InputChoicesComponent, LabelComponent, RadioComponent, TextBoxComponent, TextareaComponent, ToggleComponent };
