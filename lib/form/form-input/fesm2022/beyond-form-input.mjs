...
class ChoicesBottomSheetComponent {
    _bottomSheetRef;
    data;
    searchValue = '';
    options = new Subject();
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "19.2.1", type: ChoicesBottomSheetComponent, isStandalone: true, selector: "ng-component", ngImport: i0, template: "<div class=\"textbox-container\">\r\n  <input\r\n    #box\r\n    matInput\r\n    class=\"form-control\"\r\n    [(ngModel)]=\"this.searchValue\"\r\n    [type]=\"'text'\"\r\n    (keyup)=\"this.searchValuechanged(this.searchValue)\"\r\n  />\r\n</div>\r\n<div class=\"flex-column g-space-sm\">\r\n  <byd-card *ngFor=\"let item of this.options | async\" (click)=\"this.choice(item)\">\r\n    <byd-card-content>\r\n      {{ item.name }}\r\n    </byd-card-content>\r\n  </byd-card>\r\n</div>\r\n", styles: [""], dependencies: [{ kind: "ngmodule", type: MatFormFieldModule }, { kind: "ngmodule", type: FormsModule }, { kind: "directive", type: i4.DefaultValueAccessor, selector: "input:not([type=checkbox])[formControlName],textarea[formControlName],input:not([type=checkbox])[formControl],textarea[formControl],input:not([type=checkbox])[ngModel],textarea[ngModel],[ngDefaultControl]" }, { kind: "directive", type: i4.NgControlStatus, selector: "[formControlName],[ngModel],[formControl]" }, { kind: "directive", type: i4.NgModel, selector: "[ngModel]:not([formControlName]):not([formControl])", inputs: ["name", "disabled", "ngModel", "ngModelOptions"], outputs: ["ngModelChange"], exportAs: ["ngModel"] }, { kind: "component", type: CardComponent, selector: "byd-card", inputs: ["highlight", "shadow", "fullHeight", "noContent", "isNew"], outputs: ["click"] }, { kind: "component", type: CardContentComponent, selector: "byd-card-content" }, { kind: "pipe", type: AsyncPipe, name: "async" }, { kind: "directive", type: NgFor, selector: "[ngFor][ngForOf]", inputs: ["ngForOf", "ngForTrackBy", "ngForTemplate"] }] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.1", ngImport: i0, type: ChoicesBottomSheetComponent, decorators: [{
            type: Component,
            args: [{ selector: '', standalone: true, imports: [MatFormFieldModule, FormsModule, CardComponent, CardContentComponent, AsyncPipe, NgFor], template: "<div class=\"textbox-container\">\r\n  <input\r\n    #box\r\n    matInput\r\n    class=\"form-control\"\r\n    [(ngModel)]=\"this.searchValue\"\r\n    [type]=\"'text'\"\r\n    (keyup)=\"this.searchValuechanged(this.searchValue)\"\r\n  />\r\n</div>\r\n<div class=\"flex-column g-space-sm\">\r\n  <byd-card *ngFor=\"let item of this.options | async\" (click)=\"this.choice(item)\">\r\n    <byd-card-content>\r\n      {{ item.name }}\r\n    </byd-card-content>\r\n  </byd-card>\r\n</div>\r\n" }]
...
export { BydInputButtonComponent, CheckboxComponent, DropdownComponent, InputChoicesComponent, LabelComponent, RadioComponent, TextBoxComponent, TextareaComponent, ToggleComponent };
