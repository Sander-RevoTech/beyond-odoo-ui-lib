...
class LabelComponent {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "19.2.1", type: LabelComponent, isStandalone: true, selector: "byd-input-label", inputs: { input: "input" }, ngImport: i0, template: "<span>{{ input.label | translate }}</span>\n", styles: [""], dependencies: [{ kind: "ngmodule", type: MatFormFieldModule }, { kind: "ngmodule", type: MatInputModule }, { kind: "ngmodule", type: FormsModule }, { kind: "ngmodule", type: ReactiveFormsModule }, { kind: "pipe", type: TranslatePipe, name: "translate" }] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.1", ngImport: i0, type: LabelComponent, decorators: [{
            type: Component,
            args: [{ selector: 'byd-input-label', standalone: true, imports: [MatFormFieldModule, MatInputModule, FormsModule, ReactiveFormsModule, TranslatePipe, FormLabelComponent], template: "<span>{{ input.label | translate }}</span>\n" }]
        }], ctorParameters: () => [], propDecorators: { input: [{
                type: Input
            }] } });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.1", ngImport: i0, type: ToggleComponent, decorators: [{
            type: Component,
            args: [{ selector: 'byd-input-toggle', standalone: true, imports: [MatFormFieldModule, MatCheckboxModule, MatButtonToggleModule, MatInputModule, FormsModule, ReactiveFormsModule, TranslatePipe, MatSlideToggleModule], template: "<mat-slide-toggle [checked]=\"this.input.value\" [formControl]=\"$any(this.input.formControl)\">\n  <span class=\"label\">{{ this.input.label | translate }}</span>\n</mat-slide-toggle>\n", styles: [".label{display:block;padding-left:10px}\n"] }]
        }], ctorParameters: () => [], propDecorators: { input: [{
                type: Input
            }] } });
...
export { CheckboxComponent, DropdownComponent, LabelComponent, RadioComponent, TextBoxComponent, TextareaComponent, ToggleComponent };
