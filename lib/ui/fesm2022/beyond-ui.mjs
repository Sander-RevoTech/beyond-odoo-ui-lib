...
import { TranslatePipe, StopPropagationDirective, TaBaseComponent } from '@beyond/utils';
...
class CardTagComponent {
    constructor() { }
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.1", ngImport: i0, type: CardTagComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "19.2.1", type: CardTagComponent, isStandalone: true, selector: "byd-card-tag", ngImport: i0, template: "<ng-content></ng-content>\n", styles: [""] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.1", ngImport: i0, type: CardTagComponent, decorators: [{
            type: Component,
...
class LayoutWithNavComponent extends TaBaseComponent {
    type;
    constructor() {
        super();
    }
