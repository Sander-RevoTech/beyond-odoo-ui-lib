...
class ToastComponent {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "19.2.1", type: ToastComponent, isStandalone: true, selector: "byd-toast", inputs: { code: "code", onTop: "onTop" }, ngImport: i0, template: "<ng-template #content>\r\n  <ng-content></ng-content>\r\n</ng-template>\r\n<div>\r\n  @if (this.onTop) {\r\n    <div class=\"on-top\" [ngClass]=\"this.getTypeClass(code)\">\r\n      <ng-container *ngTemplateOutlet=\"content\"></ng-container>\r\n    </div>\r\n  } @else {\r\n    <div class=\"card\" [ngClass]=\"this.getTypeClass(code)\">\r\n      <ng-container *ngTemplateOutlet=\"content\"></ng-container>\r\n    </div>\r\n  }\r\n</div>\r\n", styles: [".on-top{position:fixed;top:0;left:0;right:0;z-index:500;margin:5px;border-radius:var(--byd-space-md);padding:var(--byd-space-md);font-size:var(--byd-font-body-md-default-size);line-height:var(--byd-font-body-md-default-line);font-weight:var(--byd-font-body-md-default-weight);background-color:var(--byd-surface-primary);box-shadow:var(--byd-shadow-brand-md)}.on-top.success{color:var(--byd-semantic-token-success)}.on-top.danger{color:var(--byd-semantic-token-alert)}.on-top.warning{color:var(--byd-semantic-token-warning)}.on-top.info{color:var(--byd-semantic-token-link)}.card{box-shadow:var(--byd-shadow-brand-md);border-radius:var(--byd-space-md);overflow:hidden;padding:var(--byd-space-lg);color:var(--byd-text-primary);background-color:var(--byd-surface-primary);font-size:var(--byd-font-body-md-default-size);line-height:var(--byd-font-body-md-default-line);font-weight:var(--byd-font-body-md-default-weight)}.success{border:1px solid var(--byd-semantic-token-success)}.danger{border:1px solid var(--byd-semantic-token-alert)}.warning{border:1px solid var(--byd-semantic-token-warning)}.info{border:1px solid var(--byd-semantic-token-link)}\n"], dependencies: [{ kind: "directive", type: NgClass, selector: "[ngClass]", inputs: ["class", "ngClass"] }, { kind: "directive", type: NgTemplateOutlet, selector: "[ngTemplateOutlet]", inputs: ["ngTemplateOutletContext", "ngTemplateOutlet", "ngTemplateOutletInjector"] }] });
}
