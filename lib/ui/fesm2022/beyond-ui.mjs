...
class ToastComponent {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "19.2.1", type: ToastComponent, isStandalone: true, selector: "byd-toast", inputs: { code: "code", sticky: "sticky" }, ngImport: i0, template: "@if (this.sticky) {\r\n  <div class=\"sticky\" [ngClass]=\"this.getTypeClass(this.code)\">\r\n    <ng-content></ng-content>\r\n  </div>\r\n} @else {\r\n  <div class=\"card\" [ngClass]=\"this.getTypeClass(this.code)\">\r\n    <ng-content></ng-content>\r\n  </div>\r\n}\r\n", styles: [".sticky{position:fixed;top:0;left:0;right:0;padding:var(--byd-space-lg);font-size:var(--byd-font-body-md-default-size);line-height:var(--byd-font-body-md-default-line);font-weight:var(--byd-font-body-md-default-weight)}.card{box-shadow:var(--byd-shadow-brand-md);border-radius:var(--byd-space-md);overflow:hidden;padding:var(--byd-space-lg);background-color:var(--byd-surface-primary);color:var(--byd-text-primary);font-size:var(--byd-font-body-md-default-size);line-height:var(--byd-font-body-md-default-line);font-weight:var(--byd-font-body-md-default-weight)}.success{border:1px solid var(--byd-semantic-token-success)}.danger{border:1px solid var(--byd-semantic-token-alert)}.warning{border:1px solid var(--byd-semantic-token-warning)}.info{border:1px solid var(--byd-semantic-token-link)}\n"], dependencies: [{ kind: "directive", type: NgClass, selector: "[ngClass]", inputs: ["class", "ngClass"] }] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.1", ngImport: i0, type: ToastComponent, decorators: [{
            type: Component,
            args: [{ selector: 'byd-toast', standalone: true, imports: [NgClass], template: "@if (this.sticky) {\r\n  <div class=\"sticky\" [ngClass]=\"this.getTypeClass(this.code)\">\r\n    <ng-content></ng-content>\r\n  </div>\r\n} @else {\r\n  <div class=\"card\" [ngClass]=\"this.getTypeClass(this.code)\">\r\n    <ng-content></ng-content>\r\n  </div>\r\n}\r\n", styles: [".sticky{position:fixed;top:0;left:0;right:0;padding:var(--byd-space-lg);font-size:var(--byd-font-body-md-default-size);line-height:var(--byd-font-body-md-default-line);font-weight:var(--byd-font-body-md-default-weight)}.card{box-shadow:var(--byd-shadow-brand-md);border-radius:var(--byd-space-md);overflow:hidden;padding:var(--byd-space-lg);background-color:var(--byd-surface-primary);color:var(--byd-text-primary);font-size:var(--byd-font-body-md-default-size);line-height:var(--byd-font-body-md-default-line);font-weight:var(--byd-font-body-md-default-weight)}.success{border:1px solid var(--byd-semantic-token-success)}.danger{border:1px solid var(--byd-semantic-token-alert)}.warning{border:1px solid var(--byd-semantic-token-warning)}.info{border:1px solid var(--byd-semantic-token-link)}\n"] }]
        }], propDecorators: { code: [{
                type: Input
            }], sticky: [{
                type: Input
