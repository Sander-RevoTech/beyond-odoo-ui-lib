...
class BadgeComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.1", ngImport: i0, type: BadgeComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "19.2.1", type: BadgeComponent, isStandalone: true, selector: "app-badge", inputs: { value: "value", type: "type" }, ngImport: i0, template: "<span class=\"badge\" [ngClass]=\"this.getClass()\">{{ this.value }}</span>\r\n", styles: [".badge{font-size:14px}.badge-danger{color:get-var(text,alert);background:get-var(semantic-token,alert)}.badge-warning{color:get-var(text,warning);background:get-var(semantic-token,warning)}.badge-success{color:get-var(text,success);background:get-var(semantic-token,success)}.badge-primary{color:get-var(surface,brand,primary);background:get-var(surface,invert)}.badge-secondary{color:get-var(surface,brand,secondary);background:get-var(surface,invert)}\n"], dependencies: [{ kind: "directive", type: NgClass, selector: "[ngClass]", inputs: ["class", "ngClass"] }] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.1", ngImport: i0, type: BadgeComponent, decorators: [{
            type: Component,
            args: [{ selector: 'app-badge', standalone: true, imports: [NgClass], template: "<span class=\"badge\" [ngClass]=\"this.getClass()\">{{ this.value }}</span>\r\n", styles: [".badge{font-size:14px}.badge-danger{color:get-var(text,alert);background:get-var(semantic-token,alert)}.badge-warning{color:get-var(text,warning);background:get-var(semantic-token,warning)}.badge-success{color:get-var(text,success);background:get-var(semantic-token,success)}.badge-primary{color:get-var(surface,brand,primary);background:get-var(surface,invert)}.badge-secondary{color:get-var(surface,brand,secondary);background:get-var(surface,invert)}\n"] }]
...
export { BadgeComponent, BydButtonComponent, BydNavigationDateDayComponent, BydNavigationDateWeekComponent, BydTextComponent, BydTitleComponent, CardBydgComponent, CardComponent, CardContentComponent, CardCtaComponent, CardHeaderComponent, CardImageComponent, CardSubtitleComponent, CardTitleComponent, EToast, EmptyComponent, ErrorComponent, LayoutContentComponent, LayoutHeaderComponent, LayoutHeaderDefaultComponent, LayoutNavComponent, LayoutPageComponent, LayoutTitleComponent, LayoutWithNavComponent, LoaderComponent, LogoComponent, PictureInfoMessageComponent, SwiperLightComponent, ToastComponent, TypedMessageComponent };
