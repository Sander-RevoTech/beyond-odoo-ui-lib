...
class ToastComponent {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "19.2.1", type: ToastComponent, isStandalone: true, selector: "byd-toast", inputs: { code: "code", sticky: "sticky" }, ngImport: i0, template: "@if (this.sticky) {\r\n  <div class=\"sticky\" [ngClass]=\"this.getTypeClass(this.code)\">\r\n    <ng-content></ng-content>\r\n  </div>\r\n} @else {\r\n  <div class=\"card\" [ngClass]=\"this.getTypeClass(this.code)\">\r\n    <ng-content></ng-content>\r\n  </div>\r\n}\r\n", styles: [".sticky{position:fixed;top:0;left:0;right:0;z-index:500;padding:var(--byd-space-lg);font-size:var(--byd-font-body-md-default-size);line-height:var(--byd-font-body-md-default-line);font-weight:var(--byd-font-body-md-default-weight);background-color:var(--byd-surface-primary)}.sticky.success{color:var(--byd-semantic-token-success)}.sticky.danger{border:var(--byd-semantic-token-alert)}.sticky.warning{border:var(--byd-semantic-token-warning)}.sticky.info{border:var(--byd-semantic-token-link)}.card{box-shadow:var(--byd-shadow-brand-md);border-radius:var(--byd-space-md);overflow:hidden;padding:var(--byd-space-lg);color:var(--byd-text-primary);font-size:var(--byd-font-body-md-default-size);line-height:var(--byd-font-body-md-default-line);font-weight:var(--byd-font-body-md-default-weight)}.success{border:1px solid var(--byd-semantic-token-success)}.danger{border:1px solid var(--byd-semantic-token-alert)}.warning{border:1px solid var(--byd-semantic-token-warning)}.info{border:1px solid var(--byd-semantic-token-link)}\n"], dependencies: [{ kind: "directive", type: NgClass, selector: "[ngClass]", inputs: ["class", "ngClass"] }] });
}
