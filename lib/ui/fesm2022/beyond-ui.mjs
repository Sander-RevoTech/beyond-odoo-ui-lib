...
class BydNavigationDateDayComponent {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "19.2.1", type: BydNavigationDateDayComponent, isStandalone: true, selector: "byd-navigation-date-day", inputs: { viewDate: "viewDate" }, outputs: { viewDateChanged: "viewDateChanged" }, ngImport: i0, template: "<div class=\"grid pb-3 justify-content-center\">\r\n  <div class=\"align-items-center\">\r\n    <byd-button (action)=\"this.previous()\" type=\"primary\">\r\n      <mat-icon>chevron_left</mat-icon>\r\n    </byd-button>\r\n  </div>\r\n\r\n  <div class=\"g-col-8 align-items-center\">\r\n    <byd-title> {{ this.viewDate | date : \"fullDate\" }} </byd-title>\r\n  </div>\r\n\r\n  <div class=\"align-items-center\">\r\n    <byd-button (action)=\"this.next()\" type=\"primary\">\r\n      <mat-icon>chevron_right</mat-icon>\r\n    </byd-button>\r\n  </div>\r\n</div>\r\n", styles: [""], dependencies: [{ kind: "component", type: BydButtonComponent, selector: "byd-button", inputs: ["state", "type", "size", "icon", "options", "stopPropagationActivation"], outputs: ["action"] }, { kind: "component", type: BydTitleComponent, selector: "byd-title", inputs: ["level", "isTheme", "isBold"] }, { kind: "pipe", type: DatePipe, name: "date" }, { kind: "component", type: MatIcon, selector: "mat-icon", inputs: ["color", "inline", "svgIcon", "fontSet", "fontIcon"], exportAs: ["matIcon"] }] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.1", ngImport: i0, type: BydNavigationDateDayComponent, decorators: [{
            type: Component,
            args: [{ selector: 'byd-navigation-date-day', standalone: true, imports: [BydButtonComponent, BydTitleComponent, DatePipe, MatIcon], template: "<div class=\"grid pb-3 justify-content-center\">\r\n  <div class=\"align-items-center\">\r\n    <byd-button (action)=\"this.previous()\" type=\"primary\">\r\n      <mat-icon>chevron_left</mat-icon>\r\n    </byd-button>\r\n  </div>\r\n\r\n  <div class=\"g-col-8 align-items-center\">\r\n    <byd-title> {{ this.viewDate | date : \"fullDate\" }} </byd-title>\r\n  </div>\r\n\r\n  <div class=\"align-items-center\">\r\n    <byd-button (action)=\"this.next()\" type=\"primary\">\r\n      <mat-icon>chevron_right</mat-icon>\r\n    </byd-button>\r\n  </div>\r\n</div>\r\n" }]
...
class BydNavigationDateWeekComponent {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "19.2.1", type: BydNavigationDateWeekComponent, isStandalone: true, selector: "byd-navigation-date-week", inputs: { viewDate: "viewDate" }, outputs: { viewDateChanged: "viewDateChanged" }, ngImport: i0, template: "<div class=\"grid pb-3 justify-content-center\">\r\n  <div class=\"align-items-center\">\r\n    <byd-button (action)=\"this.previous()\" type=\"primary\">\r\n      <mat-icon>chevron_left</mat-icon>\r\n    </byd-button>\r\n  </div>\r\n\r\n  <div class=\"g-col-8 align-items-center\">\r\n    <byd-title>\r\n      <div>\r\n        From {{ this.fromDay | date : \"dd/MM/YY\" }} to\r\n        {{ this.toDay | date : \"dd/MM/YY\" }}\r\n      </div>\r\n      <div class=\"fsz-md\">week number: {{ this.weekInYear }}</div>\r\n    </byd-title>\r\n  </div>\r\n\r\n  <div class=\"align-items-center\">\r\n    <byd-button (action)=\"this.next()\" type=\"primary\">\r\n      <mat-icon>chevron_right</mat-icon>\r\n    </byd-button>\r\n  </div>\r\n</div>\r\n", styles: [""], dependencies: [{ kind: "component", type: BydButtonComponent, selector: "byd-button", inputs: ["state", "type", "size", "icon", "options", "stopPropagationActivation"], outputs: ["action"] }, { kind: "component", type: BydTitleComponent, selector: "byd-title", inputs: ["level", "isTheme", "isBold"] }, { kind: "pipe", type: DatePipe, name: "date" }, { kind: "component", type: MatIcon, selector: "mat-icon", inputs: ["color", "inline", "svgIcon", "fontSet", "fontIcon"], exportAs: ["matIcon"] }] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.1", ngImport: i0, type: BydNavigationDateWeekComponent, decorators: [{
            type: Component,
            args: [{ selector: 'byd-navigation-date-week', standalone: true, imports: [BydButtonComponent, BydTitleComponent, DatePipe, MatIcon], template: "<div class=\"grid pb-3 justify-content-center\">\r\n  <div class=\"align-items-center\">\r\n    <byd-button (action)=\"this.previous()\" type=\"primary\">\r\n      <mat-icon>chevron_left</mat-icon>\r\n    </byd-button>\r\n  </div>\r\n\r\n  <div class=\"g-col-8 align-items-center\">\r\n    <byd-title>\r\n      <div>\r\n        From {{ this.fromDay | date : \"dd/MM/YY\" }} to\r\n        {{ this.toDay | date : \"dd/MM/YY\" }}\r\n      </div>\r\n      <div class=\"fsz-md\">week number: {{ this.weekInYear }}</div>\r\n    </byd-title>\r\n  </div>\r\n\r\n  <div class=\"align-items-center\">\r\n    <byd-button (action)=\"this.next()\" type=\"primary\">\r\n      <mat-icon>chevron_right</mat-icon>\r\n    </byd-button>\r\n  </div>\r\n</div>\r\n" }]
        }], propDecorators: { viewDate: [{
                type: Input
            }], viewDateChanged: [{
                type: Output
...
class BydBadgeComponent {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "19.2.1", type: BydBadgeComponent, isStandalone: true, selector: "byd-badge", inputs: { value: "value", type: "type" }, ngImport: i0, template: "<span class=\"badge\" [ngClass]=\"this.getClass()\">{{ this.value }}</span>\r\n", styles: [".badge{font-size:14px}.badge-danger{color:get-var(text,alert);background:get-var(semantic-token,alert)}.badge-warning{color:get-var(text,warning);background:get-var(semantic-token,warning)}.badge-success{color:get-var(text,success);background:get-var(semantic-token,success)}.badge-primary{color:get-var(surface,brand,primary);background:get-var(surface,invert)}.badge-secondary{color:get-var(surface,brand,secondary);background:get-var(surface,invert)}\n"], dependencies: [{ kind: "directive", type: NgClass, selector: "[ngClass]", inputs: ["class", "ngClass"] }] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.1", ngImport: i0, type: BydBadgeComponent, decorators: [{
            type: Component,
            args: [{ selector: 'byd-badge', standalone: true, imports: [NgClass], template: "<span class=\"badge\" [ngClass]=\"this.getClass()\">{{ this.value }}</span>\r\n", styles: [".badge{font-size:14px}.badge-danger{color:get-var(text,alert);background:get-var(semantic-token,alert)}.badge-warning{color:get-var(text,warning);background:get-var(semantic-token,warning)}.badge-success{color:get-var(text,success);background:get-var(semantic-token,success)}.badge-primary{color:get-var(surface,brand,primary);background:get-var(surface,invert)}.badge-secondary{color:get-var(surface,brand,secondary);background:get-var(surface,invert)}\n"] }]
...
class ContainerValidationComponent extends BydBaseComponent {
    dialog;
    disabled = false;
    translation = {};
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.1", ngImport: i0, type: ContainerValidationComponent, deps: [{ token: i1$1.MatDialog }], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "19.2.1", type: ContainerValidationComponent, isStandalone: true, selector: "app-container-validation", inputs: { disabled: "disabled", translation: "translation" }, outputs: { validated: "validated" }, usesInheritance: true, ngImport: i0, template: "<div (click)=\"this.openDialog()\">\r\n  <ng-content></ng-content>\r\n</div>\r\n" });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.1", ngImport: i0, type: ContainerValidationComponent, decorators: [{
            type: Component,
            args: [{ selector: 'app-container-validation', standalone: true, imports: [], template: "<div (click)=\"this.openDialog()\">\r\n  <ng-content></ng-content>\r\n</div>\r\n" }]
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.1", ngImport: i0, type: LayoutHeaderDefaultComponent, decorators: [{
            type: Component,
            args: [{ selector: 'byd-layout-header-default', standalone: true, imports: [BydTitleComponent, LogoComponent], template: "<div\n  class=\"layout-header-default-container flex-start g-space-sm\"\n  (click)=\"this.goToHome()\"\n>\n  <div class=\"d-flex\">\n    <byd-logo></byd-logo>\n  </div>\n  <div class=\"flex-column\">\n    <byd-title> <ng-content></ng-content> </byd-title>\n  </div>\n</div>\n", styles: [".layout-header-default-container{color:var(--byd-text-invert-primary);background-color:var(--byd-surface-brand-primary);padding:var(--byd-space-sm)}\n"] }]
        }] });
