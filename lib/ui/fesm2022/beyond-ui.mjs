...
class BydBadgeComponent {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "19.2.1", type: BydBadgeComponent, isStandalone: true, selector: "byd-badge", inputs: { value: "value", type: "type", icon: "icon" }, outputs: { clickAction: "clickAction" }, ngImport: i0, template: "<span class=\"badge-container\" [ngClass]=\"this.getClass()\" (click)=\"this.clickAction.emit()\">\r\n    {{ this.value }}\r\n\r\n    @if(this.icon) {\r\n        <mat-icon>{{ this.icon }}</mat-icon>\r\n    }\r\n</span>\r\n", styles: [".badge-container{display:flex;width:fit-content;padding:var(--byd-space-sm) var(--byd-space-xs);font-size:var(--byd-font-body-xs-default-size);line-height:var(--byd-font-body-xs-default-line);font-weight:var(--byd-font-body-xs-bold-weight);border-radius:6px}.badge-container .value{white-space:nowrap}.badge-info{color:var(--byd-semantic-purple-dark);background:var(--byd-semantic-purple-light)}.badge-danger{color:var(--byd-text-alert);background:var(--byd-semantic-token-alert)}.badge-warning{color:var(--byd-text-warning);background:var(--byd-semantic-token-warning)}.badge-success{color:var(--byd-text-success);background:var(--byd-semantic-token-success)}.badge-primary{color:var(--byd-text-invert-primary);background:var(--byd-surface-invert)}.badge-secondary{color:var(--byd-surface-brand-secondary);background:var(--byd-surface-invert)}\n"], dependencies: [{ kind: "directive", type: NgClass, selector: "[ngClass]", inputs: ["class", "ngClass"] }, { kind: "component", type: MatIcon, selector: "mat-icon", inputs: ["color", "inline", "svgIcon", "fontSet", "fontIcon"], exportAs: ["matIcon"] }] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.1", ngImport: i0, type: BydBadgeComponent, decorators: [{
            type: Component,
            args: [{ selector: 'byd-badge', standalone: true, imports: [NgClass, MatIcon], template: "<span class=\"badge-container\" [ngClass]=\"this.getClass()\" (click)=\"this.clickAction.emit()\">\r\n    {{ this.value }}\r\n\r\n    @if(this.icon) {\r\n        <mat-icon>{{ this.icon }}</mat-icon>\r\n    }\r\n</span>\r\n", styles: [".badge-container{display:flex;width:fit-content;padding:var(--byd-space-sm) var(--byd-space-xs);font-size:var(--byd-font-body-xs-default-size);line-height:var(--byd-font-body-xs-default-line);font-weight:var(--byd-font-body-xs-bold-weight);border-radius:6px}.badge-container .value{white-space:nowrap}.badge-info{color:var(--byd-semantic-purple-dark);background:var(--byd-semantic-purple-light)}.badge-danger{color:var(--byd-text-alert);background:var(--byd-semantic-token-alert)}.badge-warning{color:var(--byd-text-warning);background:var(--byd-semantic-token-warning)}.badge-success{color:var(--byd-text-success);background:var(--byd-semantic-token-success)}.badge-primary{color:var(--byd-text-invert-primary);background:var(--byd-surface-invert)}.badge-secondary{color:var(--byd-surface-brand-secondary);background:var(--byd-surface-invert)}\n"] }]
