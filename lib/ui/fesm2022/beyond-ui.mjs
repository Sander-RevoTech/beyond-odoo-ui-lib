...
class BydNavigationDateWeekComponent {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "19.2.1", type: BydNavigationDateWeekComponent, isStandalone: true, selector: "byd-navigation-date-week", inputs: { viewDate: "viewDate" }, outputs: { viewDateChanged: "viewDateChanged" }, ngImport: i0, template: "<div class=\"row pb-3 justify-content-center\">\r\n  <div class=\"col-auto align-items-center\">\r\n    <byd-button (action)=\"this.previous()\" type=\"primary\">\r\n      <mat-icon>chevron_left</mat-icon>\r\n    </byd-button>\r\n  </div>\r\n\r\n  <div class=\"col-6 align-items-center\">\r\n    <byd-title>\r\n      <div>\r\n        From {{ this.fromDay | date : \"dd/MM/YY\" }} to\r\n        {{ this.toDay | date : \"dd/MM/YY\" }}\r\n      </div>\r\n      <div class=\"fsz-md\">week number: {{ this.weekInYear }}</div>\r\n    </byd-title>\r\n  </div>\r\n\r\n  <div class=\"col-auto align-items-center\">\r\n    <byd-button (action)=\"this.next()\" type=\"primary\">\r\n      <mat-icon>chevron_right</mat-icon>\r\n    </byd-button>\r\n  </div>\r\n</div>\r\n", styles: [""], dependencies: [{ kind: "component", type: BydButtonComponent, selector: "byd-button", inputs: ["state", "type", "size", "icon", "options", "stopPropagationActivation"], outputs: ["action"] }, { kind: "component", type: BydTitleComponent, selector: "byd-title", inputs: ["level", "isTheme", "isBold"] }, { kind: "pipe", type: DatePipe, name: "date" }, { kind: "component", type: MatIcon, selector: "mat-icon", inputs: ["color", "inline", "svgIcon", "fontSet", "fontIcon"], exportAs: ["matIcon"] }] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.1", ngImport: i0, type: BydNavigationDateWeekComponent, decorators: [{
            type: Component,
            args: [{ selector: 'byd-navigation-date-week', standalone: true, imports: [BydButtonComponent, BydTitleComponent, DatePipe, MatIcon], template: "<div class=\"row pb-3 justify-content-center\">\r\n  <div class=\"col-auto align-items-center\">\r\n    <byd-button (action)=\"this.previous()\" type=\"primary\">\r\n      <mat-icon>chevron_left</mat-icon>\r\n    </byd-button>\r\n  </div>\r\n\r\n  <div class=\"col-6 align-items-center\">\r\n    <byd-title>\r\n      <div>\r\n        From {{ this.fromDay | date : \"dd/MM/YY\" }} to\r\n        {{ this.toDay | date : \"dd/MM/YY\" }}\r\n      </div>\r\n      <div class=\"fsz-md\">week number: {{ this.weekInYear }}</div>\r\n    </byd-title>\r\n  </div>\r\n\r\n  <div class=\"col-auto align-items-center\">\r\n    <byd-button (action)=\"this.next()\" type=\"primary\">\r\n      <mat-icon>chevron_right</mat-icon>\r\n    </byd-button>\r\n  </div>\r\n</div>\r\n" }]
        }], propDecorators: { viewDate: [{
                type: Input
            }], viewDateChanged: [{
                type: Output
