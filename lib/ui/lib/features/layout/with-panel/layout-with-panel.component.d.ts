...
export declare class BydLayoutWithPanelComponent extends BydBaseComponent implements OnChanges, AfterViewInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<BydLayoutWithPanelComponent, "byd-layout-with-panel", never, { "open": { "alias": "open"; "required": false; }; "width": { "alias": "width"; "required": false; }; }, { "close": "close"; }, never, ["app-layout-panel", "app-layout-content"], true, never>;
}
