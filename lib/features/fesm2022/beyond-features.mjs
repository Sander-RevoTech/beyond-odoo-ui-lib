...
class BydGridViewService extends BydBaseOdooService {
    ...
    getData$(model, ajaxParam, fields) {
        const filterParams = ajaxParam.filter.map(f => {
            const newField = f.field === gridSearchFieldsName ? (ajaxParam.colsMetaData.find(c => c.isSearchField)?.name ?? '') : f.field;
