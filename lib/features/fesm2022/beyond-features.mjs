...
import { signal, Injectable, inject, Input, Component, ViewChild, ViewEncapsulation } from '@angular/core';
import { BydBaseComponent, isNonNullable, TypedTemplateDirective } from '@beyond/utils';
import { TabulatorFull } from 'tabulator-tables';
import { InputDatePicker, InputPanel, InputLabel, InputNumber, InputTextBox } from '@beyond/form-model';
import { BehaviorSubject, firstValueFrom, filter, tap, mergeMap, map } from 'rxjs';
...
class BydGridFormComponent extends BydAbstractGridComponent {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "19.2.1", type: BydGridFormComponent, isStandalone: true, selector: "byd-grid-form", usesInheritance: true, ngImport: i0, template: "<byd-form [inputs]=\"this.filtersForm()\" (valid)=\"this.apply($event)\"></byd-form>", styles: [""], dependencies: [{ kind: "component", type: BydFormComponent, selector: "byd-form", inputs: ["inputs", "askValidation$", "askOnDestroy", "loader", "error", "border", "canDisplayButton", "buttonTitle", "onLive"], outputs: ["valid", "isFormValid"] }] });
}
...
class GridControlComponent extends BydAbstractGridComponent {
...
class BydGridViewService extends BydBaseOdooService {
    ...
    getData$(model, ajaxParam, fields) {
        ...
        return this._odooService
            ...
            .searchRead$(model, filterParams, fields, { "order": orderParams, "offset": (ajaxParam.page - 1) * ajaxParam.size, "limit": ajaxParam.size })
...
export { BydGridComponent, BydGridContainerComponent, BydGridFormComponent, BydGridTagsComponent, ParameterType };
