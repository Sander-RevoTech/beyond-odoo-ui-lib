...
import { Injectable, signal, inject, Input, Component, EventEmitter, ViewChild, Output, ViewEncapsulation } from '@angular/core';
import { BydFormComponent } from '@beyond/form-basic';
import { TranslatePipe } from '@beyond/translation';
import { BydTitleComponent, BydBadgeComponent, BydTextComponent, BydButtonComponent } from '@beyond/ui';
import { InputPanel, InputDropdown, InputDatePicker, InputNumber, InputChoices, InputTextBox } from '@beyond/form-model';
import { isNonNullable, getUniqueArray, BydBaseComponent, TypedTemplateDirective } from '@beyond/utils';
import { of, Subject, BehaviorSubject, firstValueFrom, distinctUntilChanged, filter, mergeMap, map } from 'rxjs';
...
class BydGridFormService {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydGridFormService, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydGridFormService, providedIn: 'root' });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydGridFormService, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root',
                }]
...
class BydGridInstanceService {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydGridInstanceService, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydGridInstanceService, providedIn: 'root' });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydGridInstanceService, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root',
                }]
...
class BydAbstractGridComponent extends BydBaseComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydAbstractGridComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "19.2.15", type: BydAbstractGridComponent, isStandalone: true, selector: "ng-component", inputs: { gridId: "gridId" }, usesInheritance: true, ngImport: i0, template: '', isInline: true });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydAbstractGridComponent, decorators: [{
            type: Component,
            args: [{ template: '' }]
...
class BydGridFormComponent extends BydAbstractGridComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydGridFormComponent, deps: null, target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "19.2.15", type: BydGridFormComponent, isStandalone: true, selector: "byd-grid-form", usesInheritance: true, ngImport: i0, template: "<div>\r\n  <byd-title [level]=\"2\">{{ 'grid.' + this.grid.scope + '.title' | translate }}</byd-title>\r\n</div>\r\n\r\n<div class=\"space-between\">\r\n  <div>\r\n    <byd-form\r\n      [inputs]=\"this.filtersForm()\"\r\n      (valid)=\"this.applyFilters($event)\"\r\n      [askOnDestroy]=\"true\"\r\n      [canDisplayButton]=\"false\"\r\n    ></byd-form>\r\n  </div>\r\n  <div>\r\n    <byd-form\r\n      [inputs]=\"this.groupForm()\"\r\n      (valid)=\"this.applyGroup($event)\"\r\n      [askOnDestroy]=\"true\"\r\n      [canDisplayButton]=\"false\"\r\n    ></byd-form>\r\n  </div>\r\n</div>\r\n", styles: [""], dependencies: [{ kind: "component", type: BydFormComponent, selector: "byd-form", inputs: ["inputs", "askValidation$", "askOnDestroy", "loader", "error", "border", "canDisplayButton", "buttonTitle", "onLive"], outputs: ["valid", "isFormValid"] }, { kind: "component", type: BydTitleComponent, selector: "byd-title", inputs: ["level", "isTheme", "isBold"] }, { kind: "pipe", type: TranslatePipe, name: "translate" }] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydGridFormComponent, decorators: [{
            type: Component,
            args: [{ selector: 'byd-grid-form', imports: [BydFormComponent, BydTitleComponent, TranslatePipe], template: "<div>\r\n  <byd-title [level]=\"2\">{{ 'grid.' + this.grid.scope + '.title' | translate }}</byd-title>\r\n</div>\r\n\r\n<div class=\"space-between\">\r\n  <div>\r\n    <byd-form\r\n      [inputs]=\"this.filtersForm()\"\r\n      (valid)=\"this.applyFilters($event)\"\r\n      [askOnDestroy]=\"true\"\r\n      [canDisplayButton]=\"false\"\r\n    ></byd-form>\r\n  </div>\r\n  <div>\r\n    <byd-form\r\n      [inputs]=\"this.groupForm()\"\r\n      (valid)=\"this.applyGroup($event)\"\r\n      [askOnDestroy]=\"true\"\r\n      [canDisplayButton]=\"false\"\r\n    ></byd-form>\r\n  </div>\r\n</div>\r\n" }]
        }] });
...
class BydGridTagsComponent extends BydAbstractGridComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydGridTagsComponent, deps: null, target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "19.2.15", type: BydGridTagsComponent, isStandalone: true, selector: "byd-grid-tags", usesInheritance: true, ngImport: i0, template: "<div class=\"space-between align-center g-space-md\">\r\n  <div class=\"list-tag flex-start g-space-sm\">\r\n    <div class=\"group-tag flex-start g-space-xs align-center\">\r\n      @if (this.group) {\r\n        {{ 'grid.core.groupBy' | translate }}:\r\n        <byd-badge [value]=\"this.group\" type=\"primary\" icon=\"close\" (clickAction)=\"this.removeGroup()\"></byd-badge>\r\n      }\r\n    </div>\r\n\r\n    @for (tag of this.activeFilters; track tag.key) {\r\n      <div class=\"item-tag flex-start g-space-xs align-center\">\r\n        <div class=\"tag-title\">{{ 'grid.' + this.gridId + '.core.' + tag.key | translate }}:</div>\r\n        @for (value of tag.values; track value.field) {\r\n          <byd-badge\r\n            [value]=\"value.type + ' ' + value.value\"\r\n            type=\"primary\"\r\n            icon=\"close\"\r\n            (clickAction)=\"this.remove(value)\"\r\n          ></byd-badge>\r\n        }\r\n      </div>\r\n    }\r\n  </div>\r\n\r\n  <div class=\"reset-n-result flex-start g-space-md align-center\">\r\n    @if (this.activeFilters.length > 0) {\r\n      <div class=\"reset\">\r\n        <byd-button (action)=\"this.clear()\">\r\n          {{ 'grid.tag.reset' | translate }}\r\n        </byd-button>\r\n      </div>\r\n    }\r\n    <div class=\"result\">\r\n      <byd-text>\r\n        {{ 'grid.tag.results' | translate: { nb: this.grid.totalItems() } }}\r\n      </byd-text>\r\n    </div>\r\n  </div>\r\n</div>\r\n", styles: [""], dependencies: [{ kind: "pipe", type: TranslatePipe, name: "translate" }, { kind: "component", type: BydBadgeComponent, selector: "byd-badge", inputs: ["value", "type", "icon", "size"], outputs: ["clickAction"] }, { kind: "component", type: BydTextComponent, selector: "byd-text", inputs: ["size", "isBold", "color"] }, { kind: "component", type: BydButtonComponent, selector: "byd-button", inputs: ["state", "type", "size", "icon", "options", "stopPropagationActivation"], outputs: ["action"] }] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydGridTagsComponent, decorators: [{
            type: Component,
            args: [{ selector: 'byd-grid-tags', standalone: true, imports: [TranslatePipe, BydBadgeComponent, BydTextComponent, BydButtonComponent], template: "<div class=\"space-between align-center g-space-md\">\r\n  <div class=\"list-tag flex-start g-space-sm\">\r\n    <div class=\"group-tag flex-start g-space-xs align-center\">\r\n      @if (this.group) {\r\n        {{ 'grid.core.groupBy' | translate }}:\r\n        <byd-badge [value]=\"this.group\" type=\"primary\" icon=\"close\" (clickAction)=\"this.removeGroup()\"></byd-badge>\r\n      }\r\n    </div>\r\n\r\n    @for (tag of this.activeFilters; track tag.key) {\r\n      <div class=\"item-tag flex-start g-space-xs align-center\">\r\n        <div class=\"tag-title\">{{ 'grid.' + this.gridId + '.core.' + tag.key | translate }}:</div>\r\n        @for (value of tag.values; track value.field) {\r\n          <byd-badge\r\n            [value]=\"value.type + ' ' + value.value\"\r\n            type=\"primary\"\r\n            icon=\"close\"\r\n            (clickAction)=\"this.remove(value)\"\r\n          ></byd-badge>\r\n        }\r\n      </div>\r\n    }\r\n  </div>\r\n\r\n  <div class=\"reset-n-result flex-start g-space-md align-center\">\r\n    @if (this.activeFilters.length > 0) {\r\n      <div class=\"reset\">\r\n        <byd-button (action)=\"this.clear()\">\r\n          {{ 'grid.tag.reset' | translate }}\r\n        </byd-button>\r\n      </div>\r\n    }\r\n    <div class=\"result\">\r\n      <byd-text>\r\n        {{ 'grid.tag.results' | translate: { nb: this.grid.totalItems() } }}\r\n      </byd-text>\r\n    </div>\r\n  </div>\r\n</div>\r\n" }]
        }] });
...
class FiltersModal {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: FiltersModal, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "19.2.15", type: FiltersModal, isStandalone: true, selector: "ng-component", ngImport: i0, template: '<div class="p-space-md"><byd-grid-form [gridId]="this.data.gridId"></byd-grid-form><byd-button (action)="this.close()">Applied</byd-button></div>', isInline: true, dependencies: [{ kind: "component", type: BydGridFormComponent, selector: "byd-grid-form" }, { kind: "component", type: BydButtonComponent, selector: "byd-button", inputs: ["state", "type", "size", "icon", "options", "stopPropagationActivation"], outputs: ["action"] }] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: FiltersModal, decorators: [{
            type: Component,
            args: [{
                    selector: '',
                    template: '<div class="p-space-md"><byd-grid-form [gridId]="this.data.gridId"></byd-grid-form><byd-button (action)="this.close()">Applied</byd-button></div>',
                    standalone: true,
                    imports: [BydGridFormComponent, BydButtonComponent],
                }]
        }] });

class BydGridSessionService {
    _filterData = new HandleComplexRequest();
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydGridSessionService, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydGridSessionService, providedIn: 'root' });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydGridSessionService, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root',
                }]
...
class BydGridViewService extends BydBaseOdooService {
    ...
    getData$(model, ajaxParam) {
        const filterParams = () => {
            ...
            return [
                ...searchField.flatMap(f => this._buildOrDomain(ajaxParam.colsMetaData.filter(c => c.isSearchField).map(f => f.name), f.value)),
        ...
        return this._odooService.searchCount$(model, filterParams()).pipe(mergeMap(count => this._odooService
            .searchRead$(model, filterParams(), ajaxParam.colsMetaData.filter(col => !col.notDisplayable).map(col => col.name), {
            ...
            return data.map(entity => this._handleJoinData(entity, mapping));
        }), map(data => ({
            data: data,
            total: count,
    ...
    _buildOrDomain(fields, value) {
        if (fields.length === 0)
            return [];
        return [...fields.slice(0, -1).map(_ => '|'), ...fields.map(field => [field, 'ilike', value])];
    }
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydGridViewService, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydGridViewService, providedIn: 'root' });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydGridViewService, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root',
                }]
...
class BydGridSearchComponent extends BydAbstractGridComponent {
    outOfBox = false;
    input = new InputTextBox();
    _session = inject(BydGridSessionService);
    constructor() {
        super();
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydGridSearchComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "19.2.15", type: BydGridSearchComponent, isStandalone: true, selector: "byd-grid-search", inputs: { outOfBox: "outOfBox" }, usesInheritance: true, ngImport: i0, template: "<byd-input-textbox [input]=\"this.input\" (valueChanged)=\"this.valueChanged($event)\"></byd-input-textbox>\r\n", styles: [""], dependencies: [{ kind: "component", type: TextBoxComponent, selector: "byd-input-textbox", inputs: ["input", "matcher", "space"], outputs: ["valueChanged"] }] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydGridSearchComponent, decorators: [{
            type: Component,
            args: [{ selector: 'byd-grid-search', imports: [TextBoxComponent], template: "<byd-input-textbox [input]=\"this.input\" (valueChanged)=\"this.valueChanged($event)\"></byd-input-textbox>\r\n" }]
...
class BydGridContainerComponent extends BydAbstractGridComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydGridContainerComponent, deps: null, target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "19.2.15", type: BydGridContainerComponent, isStandalone: true, selector: "byd-grid-container", inputs: { model: "model", colsMetaData: "colsMetaData", preset: "preset" }, viewQueries: [{ propertyName: "tableElement", first: true, predicate: ["table"], descendants: true, static: true }], usesInheritance: true, ngImport: i0, template: "<div style=\"display: none\">\r\n  <div #table></div>\r\n</div>\r\n\r\n<ng-content></ng-content>\r\n", styles: [""] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: BydGridContainerComponent, decorators: [{
            type: Component,
...
export { BydGridComponent, BydGridContainerComponent, BydGridControlComponent, BydGridFormComponent, BydGridSearchComponent, BydGridTagsComponent, FiltersModal, ParameterType };
