    ...
    init(params) {
        this.table = new TabulatorFull(params.elementRef.nativeElement, {
            ...
            ajaxRequestFunc: (url, config, ajaxParams) => {
                return firstValueFrom(params.services.getData$({ ...ajaxParams, groupBy: this.groupBy }));
            },
