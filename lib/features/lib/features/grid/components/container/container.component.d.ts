...
export declare class BydGridContainerComponent extends BydAbstractGridComponent<unknown> implements AfterViewInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<BydGridContainerComponent, "byd-grid-container", never, { "model": { "alias": "model"; "required": false; }; "colsMetaData": { "alias": "colsMetaData"; "required": false; }; "preset": { "alias": "preset"; "required": false; }; }, {}, never, ["*"], true, never>;
}
